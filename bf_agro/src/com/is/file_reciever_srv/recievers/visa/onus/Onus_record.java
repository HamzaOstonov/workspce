...
public class Onus_record
{
	...
	private String rec_cmi;
	private String code_by_type;
	private String point_code;
	private String merch_country;
	...
	public String getRec_cmi() {
		return rec_cmi;
	}
	public void setRec_cmi(String rec_cmi) {
		this.rec_cmi = rec_cmi;
	}
	public String getCode_by_type() {
		return code_by_type;
	}
	public void setCode_by_type(String code_by_type) {
		this.code_by_type = code_by_type;
	}
	...
	public String getMerch_country() {
		return merch_country;
	}
	public void setMerch_country(String merch_country) {
		this.merch_country = merch_country;
	}
	...
	public Onus_record(Long id, Long empc_file_id, Integer state_id,
			String record_type, Long line_number, String client,
			String card_acct, String accnt_ccy, String card, String slip_nr,
			String ref_number, Date tran_date_time, Date rec_date,
			Date post_date, String deal_desc, String tran_type,
			String deb_cred, String tran_ccy, Long tran_amt, Long accnt_amt,
			String terminal, String mcc_code, String merchant,
			String abvr_name, String country, String city, Long proc_id,
			Long internal_no, Long product, String iss_mfo, String term_id,
			String tranz_acct,String tran_type2,String tran_amt2
		)
	{
		super();
		this.id = id;
