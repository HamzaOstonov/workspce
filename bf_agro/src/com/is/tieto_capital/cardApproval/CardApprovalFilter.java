...
public class CardApprovalFilter implements Serializable {
	...
	public CardApprovalFilter() {
		super();
	}

	public CardApprovalFilter(Long id, String card_type, int approval_type_id, String user_id, String branch, int state_id,
