...
import com.is.card_to_card.Card;
...
public abstract class AbstractPagingListModel<T> extends AbstractListModel {
	...
	protected List<Card> getPageData1(int itemStartNumber, int pageSize,
			Object fl, String alias) {
		// TODO Auto-generated method stub
		return null;
	}

	protected List<Card> getPageData3(int itemStartNumber, int pageSize,
			Object fl, String alias) {
		// TODO Auto-generated method stub
		return null;
	}
