...
public class BprGrTypeFilter
{
	...
	public BprGrTypeFilter() 
    {

    }
	public BprGrTypeFilter(int id, int bpr_id, int oper_id, int exp_id, int graf_method, int num, int pay_period, int day, int date_from, int date_to, String name)
	{
		super();
		this.id = id;
		this.bpr_id = bpr_id;
