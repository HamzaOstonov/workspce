...
public class Products extends GenericForwardComposer{
	
	private static final long serialVersionUID = 1L;

	private Div productsdiv,grd;
	private Textbox id_client,name,massiv,street,home,home_num,doc_num,inn,notarial_doc_numb,inn_reestr,name2,polis_num;
	private Datebox doc_date,start_date,acomp_date,polis_date;
	...
	private void inputDatas(){
		if(clickbtn.equals("double")){
			...
			Utils.clearForm(productsdiv);
			productsdiv.setVisible(false);
		}
