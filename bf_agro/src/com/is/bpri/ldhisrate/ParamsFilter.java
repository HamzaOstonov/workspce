...
public ParamsFilter(int id_, String name, int id, int Id, int bpr_id, int exp_id, int rate_type, int rate_method, int pay_method, int bprid, int expId,int rate_id, Double rate) 
{
...
public int getExp_id_()
{
	return exp_id;
}

public void setExp_id_(int exp_id)
{
	this.exp_id = exp_id;
}
