...
public class Params
{
    ...
    public Params(int id_, String name, int id, int Id, int bpr_id, int exp_id, int rate_type, int rate_method, int pay_method, int bprid, int expId,int rate_id, Double rate) 
    {
