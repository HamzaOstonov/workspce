...
/*
	...
	public TrTemplate(int id, int operation_id, int acc_dt, int acc_ct,
			String currency, String doc_type, String cash_code, String purpose,
			String purpose_code, int ord, int id_transh_purp) {
		super();
		this.id = id;
		this.operation_id = operation_id;
		this.acc_dt = acc_dt;
	...
	public TrTemplate(int id, int operation_id, int acc_dt, int acc_ct,
			String currency, String doc_type, String cash_code, String purpose,
			String purpose_code, int ord, int id_transh_purp, int pay_type, int trans_type, double perc_for_tr) {
		super();
		this.id = id;
		this.operation_id = operation_id;
		this.acc_dt = acc_dt;
	  ...
	  public TrTemplate(int id, int operation_id, int acc_dt, int acc_ct, String currency, String doc_type, String cash_code, String purpose, String purpose_code, int ord, int id_transh_purp, int pay_type, int trans_type, double perc_for_tr, String pdc)
	  {
	    this.id = id;
	    this.operation_id = operation_id;
	    this.acc_dt = acc_dt;
