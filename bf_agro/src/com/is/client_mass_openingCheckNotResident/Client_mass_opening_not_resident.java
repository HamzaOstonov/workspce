...
public class Client_mass_opening_not_resident {
	...
	private String pinfl2;
	private int status;
    
    public Client_mass_opening_not_resident() {}
    
	
	public Client_mass_opening_not_resident(String pinfl, String surname, String name, String middlename,
			String nationality, String citizenship, String passport_serial, String passport_number, String birthdate,
			String gender, String birth_place, String passport_place_registration, String passport_date_registration,
			String passport_date_expiration, String code_organization, String type_card, String phone_number,
			String region, String area, String post_address, String group_code, String pinfl2) {
		super();
		this.pinfl = pinfl;
	...
	public String getPinfl2() {
		return pinfl2;
	}


	public void setPinfl2(String pinfl2) {
		this.pinfl2 = pinfl2;
	}
	...
	public String toString() {
		return "Client_mass_opening_resident [pinfl=" + pinfl + ", surname=" + surname + ", lastname=" + name
				+ ", date_birth=" + birthdate + ", code_organization=" + code_organization + ", card_type=" + type_card
				+ ", phone=" + phone_number + ", pinfl2=" + pinfl2 + ", status="+status+", group_code="+group_code+"]";
	}
