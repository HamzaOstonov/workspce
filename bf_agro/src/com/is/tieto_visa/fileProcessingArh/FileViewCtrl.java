package com.is.tieto_visa.fileProcessingArh;
...
public class FileViewCtrl extends GenericForwardComposer {
	...
	private Textbox searchFileName, tbAmount, tbTranz_acct, tbTran_type;
	...
	private Listhead fileRecords$listhead;
	...
	private Listheader fileRecords$listheader_rec_date, listheader_ref_number, fileRecords$listheader_iss_mfo;
	private Listheader fileRecords$listheader_error;
	private Listheader fileRecords$listheader_action;
	//apexbank documents file uchun begin
	private Listheader fileRecords$listheader_visa_file_id;
	private Listheader fileRecords$listheader_state_id;
	private Listheader fileRecords$listheader_line_number;
	private Listheader fileRecords$listheader_msgcode;
	private Listheader fileRecords$listheader_transtypecode;
	private Listheader fileRecords$listheader_parmvalue_drn;
	private Listheader fileRecords$listheader_localdt;
	private Listheader fileRecords$listheader_country;
	private Listheader fileRecords$listheader_city;
	private Listheader fileRecords$listheader_merchantname;
	private Listheader fileRecords$listheader_merchantid;
	private Listheader fileRecords$listheader_contractnumber;
	private Listheader fileRecords$listheader_rbsnumber;
	private Listheader fileRecords$listheader_cardexpiry;
	private Listheader fileRecords$listheader_transaction_currency;
	private Listheader fileRecords$listheader_transaction_amount;
	private Listheader fileRecords$listheader_extratgttrn_currency;
	private Listheader fileRecords$listheader_extratgtfee_currency;
	private Listheader fileRecords$listheader_extratgttrn_amount;
	private Listheader fileRecords$listheader_extratgtfee_amount;
	private Listheader fileRecords$listheader_billing_currency;
	private Listheader fileRecords$listheader_billing_amount;
	private Listheader fileRecords$listheader_sic_mcc;
	//apexbank documents file uchun end
	...
	private WayDocumentRecord currentDocRecord = new WayDocumentRecord();
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		this.binder.bindBean("currentDocRecord", this.currentDocRecord);
		this.binder.loadAll();
	...
	public void onDoubleClick$dataGrid$grd() {
		...
		fileRecords.setTitle("Поля файла (N: "+empcId+")" );
		Listhead myListhead = fileRecords$fileRecordsListbox.getListhead();
		
		//Listheader lh = new Listheader("Visa File Id");
		//lh.setHflex("1");
		//myListhead.appendChild(lh);
		
		while (myListhead.getChildren().size() > 0) {
			myListhead.removeChild(myListhead.getFirstChild());
		}
		...
		if (fileType1==8l) {
			...
			//oic_documents apex da kursatilishi kerak bulgan va kerak bulmagan polyalar
			Listheader lh = new Listheader("ID");
			lh.setHflex("min");
			myListhead.appendChild(lh);

			lh = new Listheader("VISA_FILE_ID");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			
			lh = new Listheader("STATE_ID");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("RECORD_TYPE");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("LINE_NUMBER");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("MSGCODE");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("TRANSTYPECODE");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("PARMVALUE_DRN");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("LOCALDT");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("COUNTRY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("CITY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("MERCHANTNAME");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("MERCHANTID");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("CONTRACTNUMBER");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("RBSNUMBER");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("CARDEXPIRY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("TRANSACTION_CURRENCY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("TRANSACTION_AMOUNT");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("EXTRATGTTRN_CURRENCY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("EXTRATGTFEE_CURRENCY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("EXTRATGTTRN_AMOUNT");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("EXTRATGTFEE_AMOUNT");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("BILLING_CURRENCY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("BILLING_AMOUNT");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("SIC_MCC");
			lh.setHflex("min");
			myListhead.appendChild(lh);

			lh = new Listheader("EXTRASRCTRN_CURRENCY");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("EXTRASRCTRN_AMOUNT");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			
			lh = new Listheader("Error description");
			lh.setHflex("min");
			myListhead.appendChild(lh);
			lh = new Listheader("Action");
			lh.setHflex("min");
			myListhead.appendChild(lh);
		}
		else if (fileType1==6l) { /*davr klearing*/
			Listheader lh = new Listheader("ID");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			...
			//lh.setHflex("min");
			//myListhead.appendChild(lh);
			lh = new Listheader("merchant");
			lh.setHflex("2");
			myListhead.appendChild(lh);
			lh = new Listheader("abvr_name");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			lh = new Listheader("card");
			lh.setHflex("2");
			myListhead.appendChild(lh);
			lh = new Listheader("tranz_acct");
			lh.setHflex("2");
			myListhead.appendChild(lh);
			lh = new Listheader("terminal");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			lh = new Listheader("mcc_code");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			lh = new Listheader("tran_type");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			//lh = new Listheader("ref_number");
			//lh.setHflex("min");
			//myListhead.appendChild(lh);
			lh = new Listheader("accnt_amt");
			lh.setHflex("2");
			lh.setSort("auto(accnt_amt)");
			myListhead.appendChild(lh);
			lh = new Listheader("tran_amt");
			lh.setHflex("2");
			lh.setSort("auto(tran_amt)");
			myListhead.appendChild(lh);
			lh = new Listheader("tran_amt2");
			lh.setHflex("2");
			lh.setSort("auto(tran_amt2)");
			myListhead.appendChild(lh);
			lh = new Listheader("amount");
			lh.setHflex("2");
			lh.setSort("auto(amount)");
			myListhead.appendChild(lh);
			lh = new Listheader("fee");
			lh.setHflex("2");
			lh.setSort("auto(fee)");
			myListhead.appendChild(lh);
			lh = new Listheader("tr_fee");
			lh.setHflex("2");
			lh.setSort("auto(tr_fee)");
			myListhead.appendChild(lh);
			lh = new Listheader("surcharge");
			lh.setHflex("2");
			lh.setSort("auto(surcharge)");
			myListhead.appendChild(lh);
			
			lh = new Listheader("tran_ccy");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			
			lh = new Listheader("tran_date_time");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			
			lh = new Listheader("rec_date");
			lh.setHflex("1");
			myListhead.appendChild(lh);
			...
			lh.setHflex("3");
			myListhead.appendChild(lh);
		} else if (fileType1==4l) /*trbeq file*/{
		...
		if ( fileType1==5L ) /*agro N-file*/ {
			fileRecords$listheader_merchant.setVisible(false);
			fileRecords$listheader_tranz_acct.setVisible(false);
			fileRecords$listheader_mcc_code.setVisible(false);
			fileRecords$listheader_accnt_amt.setVisible(false);
			fileRecords$listheader_tranz_acct.setVisible(false);
			fileRecords$listheader_surcharge.setVisible(false);
			fileRecords$listheader_tran_amt2.setVisible(false);
			fileRecords$listheader_tran_date_time.setLabel("E_Date");
			fileRecords$listheader_rec_date.setLabel("E_Time");
		}
		...
		this.fileRecords$fileRecordsListbox
				.setItemRenderer(new ListitemRenderer() {
					...
					public void render(Listitem item, Object data)
						...
						fillItemHumo(item, record, empcId, FileService.getBank_type(un, pwd, alias));
		...
		//this.binder.loadAll();
		this.binder.loadComponent(this.fileRecords);
	...
	public void onDoubleClick$fileRecordsListbox$fileRecords() {
		...
		if (FileService.getFileType(this.current.getId())==1L){
			...
			this.fileRecordFields$iss_mfo.setValue(record.getIss_mfo());
			this.fileRecordFields$product.setValue(record.getProduct());
			this.fileRecordFields$internal_no.setValue(record.getInternal_no()!=null ? record.getInternal_no().toString() : "");
			this.fileRecordFields$proc_id.setValue(record.getProc_id()!=null ? record.getProc_id().toString() : "");
			this.fileRecordFields$city.setValue(record.getCity());
			this.fileRecordFields$country.setValue(record.getCountry());
			this.fileRecordFields$abvr_name.setValue(record.getAbvr_name());
			this.fileRecordFields$merchant.setValue(record.getMerchant());
			...
			this.fileRecordFields$amount_acc.setValue( record.getAmount_acc()!=null ? record.getAmount_acc().toString() : "");
			this.fileRecordFields$tr_fee_code.setValue(record.getTr_fee_code());
			this.fileRecordFields$tr_fee_amt.setValue(record.getTr_fee_amt()!=null ? record.getTr_fee_amt().toString(): "");
			this.fileRecordFields$i_amount.setValue(record.getI_amount()!=null ? record.getI_amount().toString() : "");
			this.fileRecordFields$sb_amount.setValue(record.getSb_amount()!=null ? record.getSb_amount().toString() : "");
	...
	private void fillItemHumo(Listitem item, HumoFileRecords record, long empcId, String bank_type) {
		...
		item.setValue(record);
		item.setStyle("height:40px;");
		if (record.getFile_type_id()!=null && record.getFile_type_id().equals("8")) {
			item.appendChild(new Listcell(record.getId().toString()));
			/*2025.03.13 apex documents begin*/
			item.appendChild(new Listcell(record.getVisa_file_id()));
			item.appendChild(new Listcell(record.getState_id()));
			item.appendChild(new Listcell(record.getRecordtype()));
			item.appendChild(new Listcell(record.getLine_number()));
			item.appendChild(new Listcell(record.getMsgcode()));
			item.appendChild(new Listcell(record.getTranstypecode()));
			item.appendChild(new Listcell(record.getParmvalue_drn()));
			item.appendChild(new Listcell(record.getLocaldt()));
			item.appendChild(new Listcell(record.getCountry()));
			item.appendChild(new Listcell(record.getCity()));
			item.appendChild(new Listcell(record.getMerchantname()));
			item.appendChild(new Listcell(record.getMerchantid()));
			item.appendChild(new Listcell(record.getContractnumber()));
			item.appendChild(new Listcell(record.getRbsnumber()));
			item.appendChild(new Listcell(record.getCardexpiry()));
			item.appendChild(new Listcell(record.getTransaction_currency()));
			item.appendChild(new Listcell(record.getTransaction_amount()));
			item.appendChild(new Listcell(record.getExtratgttrn_currency()));
			item.appendChild(new Listcell(record.getExtratgtfee_currency()));
			item.appendChild(new Listcell(record.getExtratgttrn_amount()));
			item.appendChild(new Listcell(record.getExtratgtfee_amount()));
			item.appendChild(new Listcell(record.getBilling_currency()));
			item.appendChild(new Listcell(record.getBilling_amount()));
			item.appendChild(new Listcell(record.getSic_mcc()));
			item.appendChild(new Listcell(record.getExtrasrctrn_currency()));
			item.appendChild(new Listcell(record.getExtrasrctrn_amount()));
			/*2025.03.13 apex oic_documents end*/
			item.appendChild(new Listcell(record.getErrorText()));
			item.appendChild(new Listcell(record.getState()));
			
		} else if (record.getFile_type_id()!=null && record.getFile_type_id().equals("6")) {
			//davrbank klearing fayl
			item.appendChild(new Listcell(record.getId().toString()));
			//item.appendChild(new Listcell(record.getVisa_file_id()));
			//item.appendChild(new Listcell(record.getState_id()));
			item.appendChild(new Listcell(record.getMerchant()));
			...
			//item.appendChild(new Listcell(record.getRef_number()));
			...
			if (record.getSurcharge()!=null)
				...
				item.appendChild(new Listcell("") );
			item.appendChild(new Listcell(record.getTran_ccy()));
			item.appendChild(new Listcell(record.getTran_date_time()));
			item.appendChild(new Listcell(record.getRec_date()));
			item.appendChild(new Listcell(record.getErrorText()));
			item.appendChild(new Listcell(record.getState()));

		} else if (record.getFile_type_id()!=null && record.getFile_type_id().equals("4")) { /*trbeq*/
			...
			if (record.getSumma()!=null)
				...
				item.appendChild(new Listcell("") ) ;
			if (record.getTran_amt()!=null)
			   item.appendChild(new Listcell(dcf.format((new BigDecimal(record.getTran_amt())).divide(new BigDecimal("100"))) ) );
			else
				item.appendChild(new Listcell("") ) ;
			if (record.getTran_amt2()!=null)
			  item.appendChild(new Listcell(dcf.format((new BigDecimal(record.getTran_amt2())).divide(new BigDecimal("100"))) ) );
			else
				item.appendChild(new Listcell("") ) ;	
			if (record.getAmount()!=null)
			    item.appendChild(new Listcell(dcf.format((new BigDecimal(record.getAmount())).divide(new BigDecimal("100"))) ) );
			...
			item.appendChild(new Listcell(record.getTran_date_time()));
			item.appendChild(new Listcell(record.getRec_date()));
			item.appendChild(new Listcell(record.getIss_mfo()));			
			item.appendChild(new Listcell(record.getErrorText()));
			item.appendChild(new Listcell(record.getState()));
	...
	public void onClick$btnSearch() {
		...
		filter.setBank_type( FileService.getBank_type(un, pwd, alias));
		...
		/*if (!this.tbAmount.getValue().equals("")) {
			this.filter.setAmount(tbAmount.getValue());
		}
		if (!this.tbTranz_acct.getValue().equals("")) {
			this.filter.setTranz_acct(tbTranz_acct.getValue());
		}
		if (!this.tbTran_type.getValue().equals("")) {
			this.filter.setTran_type(tbTran_type.getValue());
		}*/
