...
public class KapitalWebService {
	...
	public ArrayList<ListCustomersItem> tietoListCustomers(ListCustomersFilter filter, ResponseInfoHolder response) {
		...
		try {
			...
			log.error(
					"** not err listCustomers issuingPortProxy  *" + issuingPortProxy.getEndpoint()+"***"+issuingPortProxy.getIssuingPort()+"***" );
			
			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(connectionInfo);
			} catch (Exception e22) {
				str1 = " listCustomers error connectionInfo";
			} finally {
			}
			log.error(
					"** not err listCustomers connectionInfo  **************" + str1);
			
			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(request);
			} catch (Exception e22) {
				str1 = " listCustomers error request";
			} finally {
			}
			log.error(
					"** not err listCustomers request  **************" + str1);			

			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(responseInfoHolder);
			} catch (Exception e22) {
				str1 = " listCustomers error responseInfoHolder";
			} finally {
			}
			log.error(
					"** not err listCustomers responseInfoHolder  **************" + str1);			

			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(resultHolder);
			} catch (Exception e22) {
				str1 = " listCustomers error resultHolder";
			} finally {
			}
			log.error(
					"** not err listCustomers resultHolder  **************" + str1);			
			...
			log.error(
					"** not err listCustomers p issuingPortProxy  *" + issuingPortProxy.getEndpoint()+"***"+issuingPortProxy.getIssuingPort()+"***" );
			
			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(connectionInfo);
			} catch (Exception e22) {
				str1 = " listCustomers p error connectionInfo";
			} finally {
			}
			log.error(
					"** not err listCustomers p connectionInfo  **************" + str1);
			
			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(request);
			} catch (Exception e22) {
				str1 = " listCustomers p error request";
			} finally {
			}
			log.error(
					"** not err listCustomers p request  **************" + str1);			

			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(responseInfoHolder);
			} catch (Exception e22) {
				str1 = " listCustomers p error responseInfoHolder";
			} finally {
			}
			log.error(
					"** not err listCustomers p responseInfoHolder  **************" + str1);			

			try {
				str1 = objectMapper.writerWithDefaultPrettyPrinter()
						.writeValueAsString(resultHolder);
			} catch (Exception e22) {
				str1 = " listCustomers p error resultHolder";
			} finally {
			}
			log.error(
					"** not err listCustomers p resultHolder  **************" + str1);			
		}
