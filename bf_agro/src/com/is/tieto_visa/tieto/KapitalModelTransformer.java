...
import visa.issuing_v_01_02_xsd.ItemType_Generic;
...
import visa.issuing_v_01_02_xsd.RowType_ExecTransaction_Response;
import visa.issuing_v_01_02_xsd.RowType_Generic;
		...
		if (inList != null) {
			...
			for (ItemType_Generic curItem : item) {
				...
				if (name.equals("CARD") && !value.equals("")) {
					...
					result.setEnd_bal((new BigDecimal(value)).divide(BigDecimal.valueOf(100)));
				} else if (name.equals("LOCKED_AMOUNT") && !value.equals("")) {
					result.setLocked_amount((new BigDecimal(value)).divide(BigDecimal.valueOf(100)));
				} else if (name.equals("AVAIL_AMOUNT") && !value.equals("")) {
					result.setAvail_amount((new BigDecimal(value)).divide(BigDecimal.valueOf(100)));
				} else if (name.equals("C_ACCNT_TYPE") && !value.equals("")) {
