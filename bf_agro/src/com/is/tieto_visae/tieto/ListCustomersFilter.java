 ...
 * PERSON_CODE				string(20)	Персональный код 
 * R_STREET					string(95)	Адрес – улица, дом, квартира
 * R_CITY					string(20)	Адрес – город
 * R_CNTRY					string(3)	Адрес – код страны
 * R_PCODE					string(7)	Адрес – почтовый индекс
 * R_E_MAILS				string(100)	Адрес – адрес электронной почты
...
public class ListCustomersFilter {
	...
	public ListCustomersFilter(String client, String status, String client_b, String f_names, String surname,
