...
import com.is.tieto_visae.customer.TietoCustomer;
...
public class TclientViewCtrlOld extends GenericForwardComposer {
	...
	private void refreshModel(int activePage) {
		...
		model = new PaginListModel(activePage, _pageSize, filter, alias, issuingPortProxy);
...
/*
  ...
  */
	...
	public void printp(TrPay trp, String report_file) {
		...
		params.put("ACCDOPER1", com.is.tieto_visae.tieto.TclientService.getkass_acc(branch, alias));
	...
	public void onClick$btn_add$addwnd() {
		...
		TietoCustomer tc;
		tc = com.is.tieto_visae.customer.CustomerService.getTietoCustomer(current.getClient(), branch, alias);
	}
