...
public class PaginListModel extends AbstractPagingListModel<Tclient> implements BindingListModel, ListModelExt
{
	private static visa.IssuingWS.IssuingPortProxy issuingPortProxy;
	...
	public PaginListModel(int startPageNumber, int pageSize, Object fl
		, String alias, visa.IssuingWS.IssuingPortProxy PortProxy)
	{
		super(startPageNumber, pageSize, fl, setPortProxy(alias, PortProxy));
	}
	
	public static String setPortProxy(String alias
		, visa.IssuingWS.IssuingPortProxy PortProxy)
	{
