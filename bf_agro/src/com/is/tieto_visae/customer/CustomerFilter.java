...
public class CustomerFilter
{
	...
	public CustomerFilter(CustomerFilter f1)
	{
		super();
		this.id = f1.id;
		this.branch = f1.branch;
		this.id_client = f1.id_client;
		this.name = f1.name;
		this.code_country = f1.code_country;
		this.code_type = f1.code_type;
		this.code_resident = f1.code_resident;
		this.code_subject = f1.code_subject;
		this.sign_registr = f1.sign_registr;
		this.code_form = f1.code_form;
		this.date_open = f1.date_open;
		this.date_close = f1.date_close;
		this.state = f1.state;
		this.p_birthday = f1.p_birthday;
		this.p_post_address = f1.p_post_address;
		this.p_passport_type = f1.p_passport_type;
		this.p_passport_serial = f1.p_passport_serial;
		this.p_passport_number = f1.p_passport_number;
		this.p_passport_place_registration = f1.p_passport_place_registration;
		this.p_passport_date_registration = f1.p_passport_date_registration;
		this.p_code_tax_org = f1.p_code_tax_org;
		this.p_number_tax_registration = f1.p_number_tax_registration;
		this.p_code_bank = f1.p_code_bank;
		this.p_code_class_credit = f1.p_code_class_credit;
		this.p_code_citizenship = f1.p_code_citizenship;
		this.p_birth_place = f1.p_birth_place;
		this.p_code_capacity = f1.p_code_capacity;
		this.p_capacity_status_date = f1.p_capacity_status_date;
		this.p_capacity_status_place = f1.p_capacity_status_place;
		this.p_num_certif_capacity = f1.p_num_certif_capacity;
		this.p_phone_home = f1.p_phone_home;
		this.p_phone_mobile = f1.p_phone_mobile;
		this.p_email_address = f1.p_email_address;
		this.p_pension_sertif_serial = f1.p_pension_sertif_serial;
		this.p_code_gender = f1.p_code_gender;
		this.p_code_nation = f1.p_code_nation;
		this.p_code_birth_region = f1.p_code_birth_region;
		this.p_code_birth_distr = f1.p_code_birth_distr;
		this.p_type_document = f1.p_type_document;
		this.p_passport_date_expiration = f1.p_passport_date_expiration;
		this.p_code_adr_region = f1.p_code_adr_region;
		this.p_code_adr_distr = f1.p_code_adr_distr;
		this.p_inps = f1.p_inps;
		this.p_pinfl = f1.p_pinfl;
		this.p_family = f1.p_family;
		this.p_first_name = f1.p_first_name;
		this.p_patronymic = f1.p_patronymic;
	}
	
	public CustomerFilter(long id, String branch, String id_client, String name,
			...
			String p_code_adr_distr, String p_inps, String p_pinfl, String p_family,
