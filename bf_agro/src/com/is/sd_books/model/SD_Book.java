...
public class SD_Book {
	...
	public SD_Book(String branch, Long id, Date open_date, String name,
			Double client_id, String client_code, String resident_code,
			String pass_type, String pass_ser, String pass_num,
			String pass_reg, Date pass_date, Date born_date, String address,
			Date ins_date, Double emp_code, Double out_id, String filial,
			String dep, Long num, Double b_id, String type_calc,
			Date date_open, Date date_close, BigDecimal saldo, Long state,
			int state_id, String account, String type_calc_show, int regime,
			String code_citizenship, String birth_place,
			String code_adr_region, String code_adr_distr, String phone_home,
			String phone_mobile, String dog_num, Date dog_dat,
			String type_document, String name_pas,
			Date passport_date_expiration, Date deadline, String is_need_book,
			String p_ser, String p_num, String p_st_name, String first_code,
			String last_code) {
	...
	public SD_Book(String filial, String dep, String name, String pass_ser,
			String pass_num, Date date_open, String client_code,
			String account, Date date_close) {
		this.filial = filial;
		this.dep = dep;
		this.pass_ser = pass_ser;
		this.pass_num = pass_num;
