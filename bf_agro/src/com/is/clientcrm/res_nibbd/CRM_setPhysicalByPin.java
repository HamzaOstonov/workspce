...
import com.is.clientcrm.res_nibbd.SSL;
...
public class CRM_setPhysicalByPin {
	...
	//		postConnection.setDoOutput(true);
			...
			int responseCode = 0;//postConnection.getResponseCode();
			ISLogger.getLogger().info("POST Response Code_setPhysicalByPin :  " + responseCode);
			ISLogger.getLogger().info("POST Response Message_setPhysicalByPin : ");
			System.out.println("POST Response Code_setPhysicalByPin :  " + responseCode);
			System.out.println("POST Response Message_setPhysicalByPin : ");

			if (responseCode == HttpsURLConnection.HTTP_OK) {

				BufferedReader in = null;//new BufferedReader(new InputStreamReader(postConnection.getInputStream(),"UTF-8"));
				String inputLine;
