...
public class TrPay {
    ...
    private String card_acc_branch;
	...
	public TrPay(Long id, String branch, int operation_id, long amount,
			...
			int emp_id, String pan, int deal_id, int tieto_type, long amount_t, String doc_num, String parent_state) {
		super();
		this.id = id;
		this.branch = branch;
		this.operation_id = operation_id;
	...
	public void setCard_acc_branch(String card_acc_branch) {
		this.card_acc_branch = card_acc_branch;
	}

	public String getCard_acc_branch() {
		return card_acc_branch;
	}
