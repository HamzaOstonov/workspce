...
public class ClientB  implements Serializable, Cloneable {
    ...
    */
    ...
    public ClientB(long id, String branch, String id_client, String name, String code_type, String sign_registr,
    ...
    public ClientB(Long id, String branch, String id_client, String name, String code_country, String code_type,
                   String code_resident, String code_subject, String sign_registr, String code_form, Date date_open,
                   Date date_close, String state, int kod_err, String file_name, String j_short_name,
    ...
    @Override
    public ClientB clone() throws CloneNotSupportedException {
        return (ClientB) super.clone();
    }

    public void rollBackObjectiveChanges(final ClientB oldClient) {
            }

    public void setClientData(ClientB client) {
        /*if (id_client != null) {
    ...
    public void setManualData(final ClientB other) {
        
    }

    public void setNotObjectiveData(final ClientB other) {
        
    }

    public boolean hasObjectiveChanges(ClientB old) {
        return false;
    }

    public boolean equalsWithoutInn(ClientB other) {
        if (other == null) {
            return false;
        }
