...
public class HumoOperationFilter {
    ...
    public HumoOperationFilter() {

    }

	public HumoOperationFilter(String id, String term_type, String oper,
			...
			String deb_cred, String country) {
		super();
		this.id = id;
