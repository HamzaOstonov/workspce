...
public class ok_periodFilter {
	    ...
	    private Double type_period_code;// проблеы  с типом
	    private Double article_code;
	    private String basis_num;
	    private Date basis_date;
	    private Double emp_code;
	    private Date ins_date;
	    private Double base_move_code;
	    ...
	    private Double post_code;
	    private Double department_code;
	    private String department;
	    private Double stag_code;
	    private String emp_code_name;

	    public ok_periodFilter() {

	    }

	    public ok_periodFilter( Double id, String branch, int personal_code, Date in_office_date, Date out_office_date, 
	    		String office_name, String office_address, String established_post, String motive_out, Double type_period_code,
	    		Double article_code, String basis_num, Date basis_date, Double emp_code, Date ins_date, Double base_move_code, 
	    		String established_department, String priz_system, String cod_bank, String cod_type_prn, String cod_pr_off, String pr_off,
	    		Date date_utv_km, String numb_utv_km, Date date_pr_kvl, String numb_pr_kvl, Date date_attest, String resh_attest, String doljn_id, 
	    		String num_pr_off, Date date_pr_off, Double post_code, Double department_code, String department, Double stag_code, String emp_code_name) {
		...
		public Double getType_period_code() {
			return type_period_code;
		}

		public void setType_period_code(Double type_period_code) {
			this.type_period_code = type_period_code;
		}

		public Double getArticle_code() {
			return article_code;
		}

		public void setArticle_code(Double article_code) {
			this.article_code = article_code;
		}
		...
		public Double getBase_move_code() {
			return base_move_code;
		}

		public void setBase_move_code(Double base_move_code) {
			this.base_move_code = base_move_code;
		}
		...
		public Double getPost_code() {
			return post_code;
		}

		public void setPost_code(Double post_code) {
			this.post_code = post_code;
		}
		...
		public Double getStag_code() {
			return stag_code;
		}

		public void setStag_code(Double stag_code) {
			this.stag_code = stag_code;
		}
		...
		public Double getDepartment_code() {
			return department_code;
		}

		public void setDepartment_code(Double department_code) {
			this.department_code = department_code;
		}
