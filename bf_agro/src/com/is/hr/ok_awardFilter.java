...
public class ok_awardFilter {
    ...
    public ok_awardFilter() {

    }

	public ok_awardFilter(int id, String branch, int personal_code, int award_date, String award_info, int emp_code,
