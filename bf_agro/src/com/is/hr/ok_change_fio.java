...
public class ok_change_fio {
    ...
    public ok_change_fio() {

    }

	public ok_change_fio(int id, String branch, int personal_code, String family, String first_name, String patronymic,
