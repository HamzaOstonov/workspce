...
public class Client_mass_opening_protocol {
	...
	public Client_mass_opening_protocol() {
	
	}

	public Client_mass_opening_protocol(int id, String client_id, String score_res, String opening_res,
