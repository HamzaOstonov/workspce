...
public class PagingListModelPayments extends AbstractPagingListModel<Tclient> implements BindingListModel, ListModelExt
{
	private static globus.IssuingWS.IssuingPortProxy issuingPortProxy;
	...
	public PagingListModelPayments(int startPageNumber, int pageSize, Object fl
		, String alias, globus.IssuingWS.IssuingPortProxy PortProxy)
	{
