...
public static HashMap<String, HashMap<Long, Bf_tr_acc>> get_accounts(Connection c)
  ...
  public static HashMap<String, String> get_bank_filials(Connection c) throws Exception
  {
...
//		  c = ConnectionPool.getConnection();
		  ps = c.prepareStatement("select * from ss_dblink_branch");
		  rs = ps.executeQuery();
		  while(rs.next())
		  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        if ((current_operation != null) && 
          (current_operation.longValue() != new_template.getOperation_id()))
        {
          tr_template.put(current_operation, current_operation_template);
          current_operation_template = new ArrayList();
        }
        current_operation_template.add(new_template);
        current_operation = Long.valueOf(new_template.getOperation_id());
      }
      if (current_operation != null) {
        tr_template.put(current_operation, current_operation_template);
      }
    ...
    throws Exception
  {
    ...
    try
    {
        ...
        ISLogger.getLogger().info("Service line 237");	
      ...
      ISLogger.getLogger().info("Service line 3247");
      ...
      System.err.println("tr_pay_id in bf_tr_pay :"+tr_pay_id);
      
      ps.execute();
      
      ISLogger.getLogger().info("Service line 258");
    }
    catch (Exception e)
    {
      throw e;
    ...
    throws Exception
  {
    ...
    try
    {
     ...
     // }
        ...
        ISLogger.getLogger().info("Service line 299");
      ps = c.prepareStatement("select seq_bf_tr_paydocs.nextval res from dual");
      rs = ps.executeQuery();
      if(rs.next()) id = Long.valueOf(rs.getLong("res"));
      ps.close();
      ps = c.prepareStatement(
	      ...
	      System.out.println("D_DATE:"+parameters.get("D_DATE"));
	      ...
	      ISLogger.getLogger().info("Service line 346");
	      ps.setLong(19, ord);
	      ...
	      System.out.println("par "+parameters.getParametersHashmap().toString());
	      ...
	      ps.execute();
	      ISLogger.getLogger().info("Service line 375");
	      
	    }
	    catch (SQLException e)
	    {
	    	ISLogger.getLogger().info("params there = "+TransactionService.name_parama);
	    	//ISLogger.getLogger().error("accounts all = "+Expt_records_processing.temp);
	      throw e;
	    }
	    finally
	    {
...
//      if(c!=null)c.close();
      ...
      while (rs.next()) {
        try
        {
          ...
          if ((action_id == 1L) || ((rs.getString("g_docid") != null) && (rs.getString("g_docid").length() != 0)))
          {
            ...
            ps_setparam.execute();
            ps_setparam.setString(1, "NAZ_PLAT");ps_setparam.setString(2, rs.getString("purp_code"));
            ps_setparam.execute();
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      System.out.println("tr_pay_id:"+tr_pay_id.longValue());
      rs = ps.executeQuery();
      while (rs.next())
      {
        ...
        ps_setparam.addBatch();
        ps_setparam.setString(1, "CURRENCY");ps_setparam.setString(2, rs.getString("acc_cl").substring(5, 8));
        ps_setparam.addBatch();
        ...
        ps_setparam.addBatch();
        ps_setparam.setString(1, "S_DEAL_ID");ps_setparam.setString(2, Long.toString(deal_id));
//        ps_setparam.setString(1, "S_DEAL_ID");ps_setparam.setString(2, Long.toString(rs.getLong("deal_id")));
        ps_setparam.addBatch();
        ps_setparam.setString(1, "FX_DEAL");ps_setparam.setString(2, Long.toString(deal_id));
//        ps_setparam.setString(1, "FX_DEAL");ps_setparam.setString(2, Long.toString(rs.getLong("deal_id")));
        ps_setparam.addBatch();
        ps_setparam.setString(1, "DEAL_ID");ps_setparam.setString(2, Long.toString(deal_id));
//        ps_setparam.setString(1, "DEAL_ID");ps_setparam.setString(2, Long.toString(rs.getLong("deal_id")));
        ps_setparam.addBatch();
        ps_setparam.setString(1, "NAZ_PLAT");ps_setparam.setString(2, rs.getString("purp_code"));
        ps_setparam.addBatch();
