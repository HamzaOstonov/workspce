...
public class File implements Serializable
{
    ...
    public File(final Long id, final Long fr_file_id, final int file_type_id, final int state_id, final String file_name, final Date file_date, final String file_state_name) {
        this.id = id;
