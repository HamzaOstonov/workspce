...
public class FileViewCtrl extends GenericForwardComposer
{
    ...
    public void doAfterCompose(final Component comp) throws Exception {
        ...
        this.dataGrid.setItemRenderer((ListitemRenderer)new ListitemRenderer() {
            public void render(final Listitem row, final Object data) throws Exception {
				...
				} else if (FileService.getFileType(pFile.getId()) == 1L || FileService.getFileType(pFile.getId()) == 4L 
						|| FileService.getFileType(pFile.getId()) == 5L) // 1-b-fayl, 4-a-file, 5-i-file
				{
    ...
    public void onDoubleClick$dataGrid$grd() {
    	...
    	final int empcFileTypeId = this.current.getFile_type_id();
    	this.fileRecords.setTitle("Поля файла. Id: "+empcId.toString());
        ...
        this.fileRecords$fileRecordsListbox.setModel((ListModel)new BindingListModelList((List)FileService.getFileRecords(empcId, empcFileTypeId), true));
