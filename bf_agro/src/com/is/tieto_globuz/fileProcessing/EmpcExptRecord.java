...
public class EmpcExptRecord implements Serializable
{
    ...
    public EmpcExptRecord(final Long id, final Double state_id, final String slip_nr, final Long tran_amt, final String mcc_code, final String merchant, final String term_id) {
        this.id = id;
        this.state_id = state_id;
        this.slip_nr = slip_nr;
        this.tran_amt = tran_amt;
    ...
    public void setState_id(final Double state_id) {
        this.state_id = state_id;
    }
    ...
    public void setLine_number(final Double line_number) {
        this.line_number = line_number;
    }
