...
public class GlobuzAccountFilter {
    ...
    public GlobuzAccountFilter() {
    	super();
    }

	public GlobuzAccountFilter(String branch, String id, String acc_bal, String currency,
