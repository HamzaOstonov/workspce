...
public enum SapEnum {
	...
	ROLE_EVENT_FOUNDER_I("BP45","P"),
	ROLE_EVENT_IP("BP55"),
	REL_TYPE_CONTACT("BUR001"),
	REL_TYPE_DIRECTOR("ZIY051"),
	REL_TYPE_ACCOUNTANT("ZIY050"),
	REL_TYPE_FOUNDER("BURC01"),
	REL_TYPE_IP("ZIY006"),
	POSITION_DIR("0001"),
	POSITION_ACC("0002"),
	PAFKT_IP("ZIY006"),
	...
	private SapEnum(String type) {
		this.value = type;
	}
	private SapEnum(String type, String nci) {
		this.value = type;
		this.nci = nci;
	}
