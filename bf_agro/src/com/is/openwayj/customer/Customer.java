...
public class Customer
{
    ...
    private String c_address_line;
    private String c_social_number;
    private String c_taxpayer_identifier;
    private String c_work_phone_number;
    private String c_mobile_phone_number;
    ...
    public String getC_address_line() {
		return c_address_line;
	}

	public String getC_social_number() {
		return c_social_number;
	}

	public String getC_taxpayer_identifier() {
		return c_taxpayer_identifier;
	}

	public String getC_work_phone_number() {
		return c_work_phone_number;
	}

	public String getC_mobile_phone_number() {
		return c_mobile_phone_number;
	}

	public void setC_address_line(String c_address_line) {
		this.c_address_line = c_address_line;
	}

	public void setC_social_number(String c_social_number) {
		this.c_social_number = c_social_number;
	}

	public void setC_taxpayer_identifier(String c_taxpayer_identifier) {
		this.c_taxpayer_identifier = c_taxpayer_identifier;
	}

	public void setC_work_phone_number(String c_work_phone_number) {
		this.c_work_phone_number = c_work_phone_number;
	}

	public void setC_mobile_phone_number(String c_mobile_phone_number) {
		this.c_mobile_phone_number = c_mobile_phone_number;
	}
