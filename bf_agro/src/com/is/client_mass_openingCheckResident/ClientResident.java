...
public class ClientResident {
	...
	public ClientResident(String id, String pinfl, String lastname, String date_birth, String code_organization,
			String card_type, String phone, String acc_group, String status, String passport_series, String passport_number) {
		super();
		this.id = id;
		this.pinfl = pinfl;
		this.lastname = lastname;
	...
	public String toString() {
		return "ClientResident [pinfl=" + pinfl + ", lastname=" + lastname + ", date_birth=" + date_birth
				+ ", code_organization=" + code_organization + ", card_type=" + card_type + ", phone="
				+ phone + ", passport_series=" + passport_series + ", passport_number="
				+ passport_number + "]";
	}
