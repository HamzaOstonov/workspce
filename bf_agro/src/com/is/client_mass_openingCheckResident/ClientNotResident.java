...
public class ClientNotResident {
	...
	public ClientNotResident(String pinfl, String firstname, String lastname, String patronymic, String nationality,
			...
			String type_card, String phone, String region, String district, String address, String acc_group) {
		super();
		this.pinfl = pinfl;
	...
	public ClientNotResident(String id, String pinfl, String firstname, String lastname, String patronymic,
			String nationality, String citizenship, String passport_serial, String passport_number, String date_birth,
			String code_gender, String birth_place, String issued_by, String date_issue, String validity_expire,
			String organization_code, String type_card, String phone, String region, String district, String address,
			String acc_group) {
		super();
		this.id = id;
		this.pinfl = pinfl;
...
public void setDate_issue(String date_issue) {
	...
	public String toString() {
		return "ClientNotResident [id=" + id + ", pinfl=" + pinfl + ", firstname=" + firstname + ", lastname="
				+ lastname + ", patronymic=" + patronymic + ", nationality=" + nationality + ", citizenship="
				+ citizenship + ", passport_serial=" + passport_serial + ", passport_number=" + passport_number
				+ ", date_birth=" + date_birth + ", code_gender=" + code_gender + ", birth_place=" + birth_place
				+ ", issued_by=" + issued_by + ", date_issue=" + date_issue + ", validity_expire=" + validity_expire
