...
public class ClientAViewCtrl extends GenericForwardComposer {
	...
	protected Window sap_bapiret, sector_wnd, nibbd_modal, nibbd_wnd,
			account_wnd, fields_diff_wnd, searchWnd, clientmain, specclt_wnd,
			clt_dlg_wnd, director_search_wnd, appsWnd;
	protected Div grd, frm, filterdiv, addgrd, account_parent, apersons_div,
			specclt_div, appsDiv, j_view, i_view, ipView, j_acc_grid,
			ip_acc_grid, director_grb, accounter_grb, j_contact_grid,
			client_bank__grid_main, client_bank_grid_acc, p_view, p_header,
			p_capacity_div, p_acc_grid, j_header, i_acc_grid, fp_view;
	...
	protected Listbox dataGrid, history, sap_bapiret$messages, atachments,
			searchWnd$searchListbox;
	protected Tabbox cl_tabs;
	protected Tab acc_tab, specclt_tab, attach_tab, history_tab;// ,
																// cards_tab;
	protected Tabpanel acc_tab_panel, specclt_tab_panel, attach_tab_panel,
			history_tab_panel;// ,
	protected Include incl_acc, incl_cards, director_search_wnd$search_incl;

	protected Groupbox aj_view, aj_acc_grid, aj_other_grid, aj_contact_grid,
			aipView, aipView2, aclient_bank_grid_acc, aclient_bank_grid_main,
			aaccounter_grb, adirector_grb;
	protected Groupbox fjView, fipView, fipView2, facc_grb, fother_grb,
			fcontacs_grb, directors_grb, grpfltmain;
	protected Row aactivity_type_row, row_non_resident, row_non_resident_new,
			row_OKED_new, rowIpViewPatentExpNew;
	protected Toolbarbutton btn_last, btn_next, btn_prev, btn_first, btn_save,
			btn_clear, btn_back, btn_get_ip, btn_sendFile, btn_new;
	...
	protected Checkbox j_sign_trade, j_small_business, j_sign_dep_acc,
			fields_diff_wnd$check_all_sap, fields_diff_wnd$check_all_ebp;
	protected Datebox j_date_registration, j_patent_expiration,
			aj_patent_expiration, documentDate;

	protected Textbox p_passport_place_registration, p_passport_serial,
			p_passport_number, description, type_non_residentValue, iopfValue,
			iformValue, isectorValue, iorgan_directValue, swift_idValue,
			ftax_orgValue, fcl_activity_type_idValue, fformValue, fopfValue,
			atype_non_residentValue, aswift_idValue,
			adirector_type_document_text, adirector_pass_place_region_text,
			adirector_pass_place_distr_text, adirector_code_citizenship_text,
			adirector_code_country_text, adirector_code_adr_region_text,
			adirector_code_adr_distr_text, adirector_code_tax_org_text,
			aaccountant_type_document_text, aaccountant_pass_place_region_text,
			aaccountant_pass_place_distr_text,
			aaccountant_code_citizenship_text, aaccountant_code_country_text,
			aaccountant_code_adr_region_text, aaccountant_code_adr_distr_text,
			aaccountant_code_tax_org_text, class_creditValue, a_formValue,
			a_organ_directValue;
	protected Datebox p_birthday, p_passport_date_registration,
			p_passport_date_expiration;
	protected RefCBox p_code_nation, ai_form, ai_sector, ai_organ_direct,
			a_type_document;
	protected Textbox p_birth_place, p_post_address, p_code_adr_distr_text,
			p_tax_orgValue, p_code_adr_region_text, p_citizenshipValue,
			p_pass_distrValue, p_pass_regionValue, p_code_citizenship_text,
			p_type_document_text, a_code_adr_region_text,
			a_code_adr_distr_text, p_type_docValue, a_code_citizenship_text,
			fp_code_citizenship_text, fp_type_document_text,
			fp_code_adr_distr_text, fp_code_adr_region_text,
			fp_code_capacity_text, ap_first_name, ap_family, p_first_name,
			p_family, p_code_tax_org_text;

	protected Textbox j_short_name, j_place_regist_name, name,
			j_number_registration_doc, j_number_tax_registration,
			j_code_head_organization, j_account, j_post_address, j_phone,
			j_fax, j_email, j_soato, j_okpo, j_inn_head_organization,
			j_responsible_emp, a_type_document_text;
	protected Textbox typeValue, regionValue, tax_orgValue, opfValue,
			formValue, oldsectorValue, organ_directValue, distrValue,
			sectorValue, bankValue, code_country_value, aiopfValue,
			aiformValue, aisectorValue, aiorgan_directValue, a_tax_orgValue,
			a_opfValue, a_sectorValue;

	private RefCBox code_resident, code_type, code_form, state, j_code_tax_org,
			a_code_tax_org, j_code_organ_direct, j_code_bank, j_region,
			j_distr, j_opf, j_code_sector, cl_activity_type_id, a_opf,
			a_code_form, a_code_sector, a_code_organ_direct, a_code_bank,
			p_code_type, p_code_resident, p_state, ap_state;
	protected RefCBox p_code_tax_org, p_code_gender, p_type_document,
			p_code_adr_region, p_code_adr_distr, p_code_citizenship,
			code_country, director_type_document, director_pass_place_region,
			director_pass_place_distr, director_code_citizenship,
			accountant_type_document, accountant_pass_place_region,
			accountant_pass_place_distr, accountant_code_citizenship,
			accountant_code_country, accountant_code_adr_region,
			accountant_code_adr_distr, accountant_code_tax_org,
			a_code_adr_region, a_code_adr_distr, a_code_citizenship, a_region,
			a_distr, p_code_country;

	protected Textbox ftypeValue, fregionValue, fsectorValue,
			fcode_country_value;
	protected RefCBox fcode_country, fcode_resident, fcode_type, fcode_form,
			fstate, fj_code_tax_org, fsign_registr, fj_code_organ_direct,
			fj_code_class_credit, fj_code_bank, fj_region, fj_distr, fj_opf,
			fj_code_sector, j_code_class_credit, a_code_class_credit,
			p_code_class_credit;

	protected RefCBox fp_code_tax_org, fp_code_gender, fp_type_document,
			fp_code_adr_region, fp_code_adr_distr, fp_code_citizenship,
			fp_code_nation, fp_pass_place_region, fp_pass_place_district;
	protected Textbox fid_client;

	protected Textbox aname, aj_short_name, ap_birth_place,
			ap_number_tax_registration, aj_number_registration_doc,
			aj_place_regist_name, aj_okpo, aj_post_address,
			aj_number_tax_registration, aj_code_head_organization,
			aj_inn_head_organization, aj_soato, aj_phone, aj_fax, aj_email;
	protected Textbox atypeValue, adistrValue, acode_country_value,
			aregionValue, aopfValue, atax_orgValue, aformValue,
			aorgan_directValue, abankValue, asectorValue, aoldsectorValue,
			ap_code_adr_distrValue;
	protected RefCBox acode_country, acode_country1, acode_resident,
			acode_type, acode_form, aj_code_tax_org, aj_code_organ_direct,
			aj_code_bank, aj_region, aj_distr, aj_opf, aj_code_sector,
			acl_activity_type_id, fcl_activity_type_id;
	protected Checkbox aj_sign_trade, aj_small_business, aj_sign_dep_acc;
	protected Datebox aj_date_registration;
	protected RefCBox acode_subject, abranch, ap_code_citizenship,
			ap_code_nation, ap_type_document, ap_code_gender,
			ap_code_bank_combobox, ap_code_class_credit, ap_code_adr_region,
			ap_code_capacity, ap_code_tax_org, ap_code_adr_distr,
			a_code_gender, a_code_nation, p_code_capacity, p_code_bank,
			fp_code_capacity;
	protected Datebox ap_passport_date_registration,
			ap_passport_date_expiration, ap_capacity_status_date, ap_birthday;
	protected Textbox ap_passport_number, ap_passport_serial,
			ap_num_certif_capacity, ap_pension_sertif_serial,
			ap_capacity_status_place, ap_passport_place_registration,
			ap_post_address_street, ap_post_address_quarter,
			ap_post_address_flat, ap_post_address, ap_post_address_house;
	protected Textbox ap_code_citizenship_text, ap_type_document_text,
			ap_code_adr_region_text, ap_code_adr_distr_text,
			atype_non_resident, ap_typeValue, ap_code_country_value,
			ap_code_tax_org_text, ap_bankValue, p_bankValue,
			ap_code_capacity_text, ap_class_creditValue, p_code_capacity_text,
			p_class_creditValue;

	protected RefCBox acode_resident1, attch_types, ap_code_bank, ap_code_type,
			ap_code_resident, ap_code_country;

	protected Label acode_countryLabel, aresLabel, aokpo_label;
	protected Label countryLabel, resLabel, okpo_label;

	@SuppressWarnings("unused")
	protected RefCBox swift_id, type_non_resident, ai_code_sector,
			ai_code_organ_direct, aswift_id;

	protected RefCBox code_resident1;
	protected Textbox acl_activity_type_idValue;

	protected RefCBox adirector_type_document, adirector_code_resident,
			adirector_code_citizenship, adirector_code_country,
			adirector_code_gender, adirector_code_nation,
			adirector_code_tax_org, adirector_pass_place_region,
			adirector_pass_place_distr, adirector_code_adr_distr,
			adirector_code_adr_region;
	private Textbox adirector_passport_serial, adirector_passport_number,
			adirector_passport_place_registration;
	private Datebox adirector_passport_date_expiration,
			adirector_passport_date_registration, adirector_birthday,
			fdate_open, fdate_open1, fdate_close, fdate_close1;

	protected Checkbox adirector_pass_place_checkbox;

	protected RefCBox aaccountant_type_document, aaccountant_code_resident,
			aaccountant_code_citizenship, aaccountant_code_country,
			aaccountant_code_gender, aaccountant_code_nation,
			aaccountant_code_tax_org, aaccountant_pass_place_region,
			aaccountant_pass_place_distr, aaccountant_code_adr_distr,
			aaccountant_code_adr_region, accountant_code_nation,
			accountant_code_resident, accountant_code_gender;
	protected Textbox director_type_document_text,
			director_pass_place_region_text, director_pass_place_distr_text,
			director_code_citizenship_text, accountant_type_document_text,
			accountant_pass_place_region_text,
			accountant_pass_place_distr_text, accountant_code_citizenship_text,
			accountant_code_country_text, accountant_code_adr_region_text,
			accountant_code_adr_distr_text;
	protected Textbox cl_activity_type_idValue, accountant_code_tax_org_text;
	private Textbox aaccountant_passport_serial, aaccountant_passport_number,
			aaccountant_passport_place_registration;
	private Datebox aaccountant_passport_date_expiration,
			aaccountant_passport_date_registration, aaccountant_birthday;
	...
	protected void setModels() {
		...
		type_non_resident.setModel(new ListModelList(DictionaryKeeper
				.getNonResidentTypes()));

		p_code_nation
				.setModel(new ListModelList(DictionaryKeeper.getNations()));
		ap_code_nation
				.setModel(new ListModelList(DictionaryKeeper.getNations()));
		fp_code_nation
				.setModel(new ListModelList(DictionaryKeeper.getNations()));
		...
		ap_code_gender
				.setModel(new ListModelList(DictionaryKeeper.getGender()));
		fp_code_gender
				.setModel(new ListModelList(DictionaryKeeper.getGender()));

		p_code_citizenship.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));
		ap_code_citizenship.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));
		fp_code_citizenship.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));

		p_type_document.setModel(new ListModelList(DictionaryKeeper
				.getPassportTypes()));
		ap_type_document.setModel(new ListModelList(DictionaryKeeper
				.getPassportTypes()));
		fp_type_document.setModel(new ListModelList(DictionaryKeeper
				.getPassportTypes()));
		...
		code_country
				.setModel(new ListModelList(DictionaryKeeper.getCountries()));
		p_code_country.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));
		ap_code_country.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));
		fcode_country.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));

		code_resident.setModel(new ListModelList(DictionaryKeeper
				.getResidentTypes()));
		p_code_resident.setModel(new ListModelList(DictionaryKeeper
				.getResidentTypes()));
		ap_code_resident.setModel(new ListModelList(DictionaryKeeper
				.getResidentTypes()));
		fcode_resident.setModel(new ListModelList(DictionaryKeeper
				.getResidentTypes()));

		code_type
				.setModel(new ListModelList(DictionaryKeeper.getClientTypes()));
		fcode_type
				.setModel(new ListModelList(DictionaryKeeper.getClientTypes()));
		p_code_type.setModel(new ListModelList(DictionaryKeeper
				.getClientTypes()));
		ap_code_type.setModel(new ListModelList(DictionaryKeeper
				.getClientTypes()));
		...
		j_code_organ_direct.setModel(new ListModelList(DictionaryKeeper
				.getSoogun()));
		...
		j_code_class_credit.setModel(new ListModelList(DictionaryKeeper
				.getCreditklass()));
		// a_code_class_credit.setModel(new
		// ListModelList(DictionaryKeeper.getCreditklass()));
		p_code_class_credit.setModel(new ListModelList(DictionaryKeeper
				.getCreditklass()));
		ap_code_class_credit.setModel(new ListModelList(DictionaryKeeper
				.getCreditklass()));

		j_region.setModel(new ListModelList(DictionaryKeeper.getRegions()));
		p_code_adr_region.setModel(new ListModelList(DictionaryKeeper
				.getRegions()));
		ap_code_adr_region.setModel(new ListModelList(DictionaryKeeper
				.getRegions()));
		fp_code_adr_region.setModel(new ListModelList(DictionaryKeeper
				.getRegions()));

		j_distr.setModel(new ListModelList(DictionaryKeeper.getDistricts()));
		p_code_adr_distr.setModel(new ListModelList(DictionaryKeeper
				.getDistricts()));
		ap_code_adr_distr.setModel(new ListModelList(DictionaryKeeper
				.getDistricts()));
		fp_code_adr_distr.setModel(new ListModelList(DictionaryKeeper
				.getDistricts()));
		...
		director_code_citizenship.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));
		director_type_document.setModel(new ListModelList(DictionaryKeeper
				.getPassportTypes()));
		accountant_code_citizenship.setModel(new ListModelList(DictionaryKeeper
				.getCountries()));
		accountant_type_document.setModel(new ListModelList(DictionaryKeeper
				.getPassportTypes()));
		...
		cl_activity_type_id.setModel(new ListModelList(DictionaryKeeper
				.getActivityType()));
		...
		p_code_capacity.setModel(new ListModelList(DictionaryKeeper
				.getCapacity()));
		ap_code_capacity.setModel(new ListModelList(DictionaryKeeper
				.getCapacity()));
		fp_code_capacity.setModel(new ListModelList(DictionaryKeeper
				.getCapacity()));
	...
	protected void refreshModel(int activePage, boolean showFirstPage) {// ,
		...
		List<ClientA> clientList = ClientAService.getListWithPaging(activePage,
				_pageSize, filter, un, pw, alias);
		clientAPaging.setTotalSize(ClientAService.getCount(filter, un, pw,
				alias));
	...
	protected void initNewClientJ() {
		...
		aj_sign_trade.setChecked(newcl.getJ_sign_trade() != null
				&& newcl.getJ_sign_trade().equals(ClientUtil.CHECKBOX_Y));
		aj_small_business.setChecked(newcl.getJ_small_business() != null
				&& newcl.getJ_small_business().equals(ClientUtil.CHECKBOX_Y));
		binder.loadAll();
	...
	protected void showCodesForCurrent() {
		...
		((Textbox) cl_activity_type_id.getPreviousSibling()).setValue(current
				.getJ_type_activity());
	...
	private void drawActions(ClientA client) {
		...
		System.out.println("dictionaryKeeper:"+dictionaryKeeper+" client:"+client+" un:"+un+" pw:"+pw+" alias:"+alias);
		
		
		Map<Integer, String> availableActionsMap = dictionaryKeeper
				.getAvailableActionsMap(client, un, pw, alias);
		...
		for (Component comp : list) {
			if (comp instanceof Toolbarbutton) {
				if (((Toolbarbutton) comp).getId().contains("act0")) {
					...
					for (Map.Entry<Integer, String> entry : availableActionsMap
							.entrySet()) {
	...
	public void onDoubleClick$dataGrid$grd() {
		...
		try {
			...
			current = ClientAService.getItemByStringId(
					currentListItem.getBranch(),
					currentListItem.getId_client(), un, pw, alias);
			if (current != null)
		...
		if (current != null) {
			...
			j_small_business.setChecked(current.getJ_small_business() != null
					&& current.getJ_small_business().equals(
							ClientUtil.CHECKBOX_Y));
			j_sign_trade.setChecked(current.getJ_sign_trade() != null
					&& current.getJ_sign_trade().equals(ClientUtil.CHECKBOX_Y));
			j_sign_dep_acc.setChecked(current.getJ_sign_dep_acc() != null
					&& current.getJ_sign_dep_acc()
							.equals(ClientUtil.CHECKBOX_Y));
			if (current.getCode_type().equals(ClientUtil.CODE_TYPE_IP)) {
				current.setP_number_tax_registration(current
						.getJ_number_tax_registration());
	...
	protected void refreshCurrent() {
		setCurrent(clientService.getItemByStringId(current.getBranch(),
				current.getId_client(), un, pw, alias));
		onDoubleClick$dataGrid$grd();
	}
	...
	public void select_code_type() {
		if (current.getCode_type() != null) {
			...
			boolean isBankType = current.getCode_type().equals(
					ClientUtil.CODE_TYPE_BANK);
			showView_frm(current.getCode_type());
			...
			boolean isAllowed = current.getCode_type().equals(
					ClientUtil.CODE_TYPE_NON_FINANCIAL)
					|| current.getCode_type()
							.equals(ClientUtil.CODE_TYPE_OTHER);
			// j_patent_expiration.setDisabled(!(isIp || isAllowed));
			// rowIpViewPatentExp.setVisible(isIp || isAllowed);
			Label j_patent_expiration_label = (Label) j_patent_expiration
					.getPreviousSibling();
			j_patent_expiration_label
					.setValue(isAllowed == true ? "Срок действия аккредитация"
	...
	public void onChange$regionValue() {
		...
		j_distr.setModel(new ListModelList(ClientDictionaries.getDistrByRegion(
				null, j_region.getValue(), alias)));
	}
	...
	public void onBlur$aname() {
		if (aj_short_name.getValue() == null
				|| aj_short_name.getValue().isEmpty()) {
			int len = aname.getValue().length();
			aj_short_name.setValue(aname.getValue().substring(0,
					len < 25 ? len : 25));
	...
	public void select_acode_type() {
		...
		boolean isBankType = newcl.getCode_type().equals(
				ClientUtil.CODE_TYPE_BANK);
		...
		if (newcl.getCode_type() != null) {
			...
			newcl.setCode_subject(isBankType ? ClientUtil.CODE_SUBJECT_I
					: ClientUtil.CODE_SUBJECT_J);

			boolean isAllowed = newcl.getCode_type().equals(
					ClientUtil.CODE_TYPE_NON_FINANCIAL)
			...
			Label j_patent_expiration_label = (Label) aj_patent_expiration
					.getPreviousSibling();
	...
	public void onChange$aregionValue() {
		...
		aj_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, aj_region.getValue(), alias)));
	}
	...
	public void onChange$aj_soato() {
		...
		if (soato != null) {
			...
			aj_distr.setModel(new ListModelList(ClientDictionaries
					.getDistrByRegion(null, newcl.getJ_region(), alias)));
	...
	public void getSectors() {
		...
		try {
			...
			sector_wnd$sectors.setModel(new BindingListModelList(sectorsList,
					true));
	...
	public void onChange$sectorGroups$sector_wnd() {
		...
		if (selItem != null) {
			sector_wnd$sectors.setModel(new BindingListModelList(
					sortSectorsByGroup(selItem), true));
		}
	}
	...
	public void onClick$find_sector$sector_wnd() throws InterruptedException {
		...
		// + "");
		if (sector_wnd$item.getValue() == null
				|| sector_wnd$item.getValue().isEmpty()) {
			getSectors();
		}
		sector_wnd$sectors.setModel(new BindingListModelList(ClientDictionaries
				.getSectorByName(sector_wnd$item.getValue(), alias), true));
	}
	...
	public void onClick$btn_pick$sector_wnd() {
		S_spr_oked selItem = (S_spr_oked) sector_wnd$sectors.getSelectedItem()
				.getValue();
		if (addgrd.isVisible()) {
	...
	public void onCheckField(Event event) {
		Checkbox checkBox = (Checkbox) ((ForwardEvent) event).getOrigin()
				.getTarget();
	...
	public void onCtrlKey$organ_directValue(KeyEvent keyEvent)
	...
	private void showSoogunWnd() throws InterruptedException {
		if (soogunWnd == null)
			soogunWnd = (Window) Executions.createComponents("/soogun.zul",
					self, null);
	...
	public void onCtrlKey$aorgan_directValue(KeyEvent keyEvent)
			throws InterruptedException {
		int keyCode = keyEvent.getKeyCode();
		if (keyCode == 120)
			showSoogunWnd();
	...
	protected void showView_frm(String codeType) {
		...
		row_non_resident.setVisible(!isIp
				&& !current.getSign_registr().equals("2"));
		...
		j_acc_grid.setVisible(!isIp && !current.getSign_registr().equals("2")
				&& !current.getSign_registr().equals("4"));
		ip_acc_grid.setVisible(isIp);

		director_grb.setVisible(!isForeignBank && !isIp
				&& !current.getSign_registr().equals("2"));
		accounter_grb.setVisible(!isForeignBank && !isIp
				&& !current.getSign_registr().equals("2"));
		j_view.setVisible(!isIp && !isForeignBank
				&& !current.getSign_registr().equals("2"));
		ipView.setVisible(isIp);
	...
	public void onChange$p_code_adr_region() {
		...
		p_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, p_code_adr_region.getValue(), alias)));
	...
	public void onChange$p_code_adr_region_text() {
		...
		current.setP_code_adr_distr(null);
		p_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, p_code_adr_region_text.getValue(),
						alias)));
		p_code_adr_region.setSelecteditem(p_code_adr_region_text.getValue());
		current.setP_code_adr_region(p_code_adr_region_text.getValue());
	}
	...
	public void onChange$a_code_adr_region_text() {
		...
		// Events.sendEvent(new Event(Events.ON_CHANGE, j_region));
		a_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, a_code_adr_region_text.getValue(),
						alias)));
	}
	...
	public void onChange$a_code_adr_region() {
		...
		a_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, a_code_adr_region.getValue(), alias)));
	}
	...
	public void onChange$ap_post_address_flat() {
		ap_post_address.setValue(ap_code_adr_region.getText() + " "
				+ ap_code_adr_distr.getText() + " "
				+ ap_post_address_street.getText() + " "
				+ ap_post_address_quarter.getText() + " "
				+ ap_post_address_house.getText() + " "
				+ ap_post_address_flat.getText());
		newcl.setP_post_address(ap_code_adr_region.getText() + " "
				+ ap_code_adr_distr.getText() + " "
				+ ap_post_address_street.getText() + " "
				+ ap_post_address_quarter.getText() + " "
				+ ap_post_address_house.getText() + " "
	...
	public void onChange$ap_code_adr_region() {
		...
		newcl.setP_code_adr_distr(null);
		ap_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, ap_code_adr_region.getValue(), alias)));
	...
	public void onChange$ap_code_adr_region_text() {
		...
		newcl.setP_code_adr_distr(null);
		ap_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, ap_code_adr_region_text.getValue(),
						alias)));
	...
	private void names(ClientA client) {
		client.setP_family(ClientUtil
				.transliterate(client.getP_last_name_cyr()).toUpperCase());
		client.setP_first_name(ClientUtil.transliterate(
				client.getP_first_name_cyr()).toUpperCase());
		client.setP_patronymic(ClientUtil.transliterate(
				client.getP_patronymic_cyr()).toUpperCase());
		if (addgrd.isVisible()) {
			StringBuilder sb = new StringBuilder();
			sb.append("YATT '").append(client.getP_family()).append(" ")
					.append(client.getP_first_name()).append(" ")
					.append(client.getP_patronymic()).append("'");
			int len = sb.length();
			client.setJ_short_name(sb.toString().substring(0,
					len < 25 ? len : 25));
	...
	public void onChange$adirector_type_document_text() {
		...
		adirector_type_document.setSelecteditem(adirector_type_document_text
				.getValue());
		change_adirector_type_document();
	}

	public void onChange$adirector_type_document() {
		adirector_type_document_text.setValue(adirector_type_document
				.getValue());
	...
	public void change_adirector_type_document() {
		if (adirector_type_document.getValue().equals("1")) {
			...
			Events.postEvent(adirector_passport_serial, new Event(
					"onInitRender"));
			Events.postEvent(adirector_passport_number, new Event(
					"onInitRender"));
	...
	public void onCheck$adirector_pass_place_checkbox() {
		adirector_pass_place_region.setDisabled(adirector_pass_place_checkbox
				.isChecked());
		adirector_pass_place_region_text
				.setDisabled(adirector_pass_place_checkbox.isChecked());
		adirector_pass_place_distr.setDisabled(adirector_pass_place_checkbox
				.isChecked());
		adirector_pass_place_distr_text
				.setDisabled(adirector_pass_place_checkbox.isChecked());
	...
	public void onChange$adirector_pass_place_region() {
		...
		adirector_pass_place_region_text.setValue(adirector_pass_place_region
				.getValue());
	...
	public void onChange$adirector_pass_place_region_text() {
		...
		adirector_pass_place_region
				.setSelecteditem(adirector_pass_place_region_text.getValue());
		// newcl.getDirector().setPass_place_region(adirector_pass_place_region.getValue());
	}

	public void onChange$adirector_pass_place_distr() {
		adirector_pass_place_distr_text.setValue(adirector_pass_place_distr
				.getValue());
		adirector_passport_place_registration
				.setText(adirector_pass_place_region.getText() + " "
						+ adirector_pass_place_distr.getText() + " " + "ИИБ");
	...
	public void onChange$adirector_pass_place_distr_text() {
		adirector_pass_place_distr
				.setSelecteditem(adirector_pass_place_distr_text.getValue());
		adirector_passport_place_registration
				.setText(adirector_pass_place_region.getText() + " "
						+ adirector_pass_place_distr.getText() + " " + "ИИБ");
		// newcl.getDirector().setPassport_place_registration(
	...
	public void onChange$adirector_code_adr_region() {
		adirector_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, adirector_code_adr_region.getValue(),
						alias)));
		// newcl.getDirector().setCode_adr_region(adirector_code_adr_region.getValue());
		adirector_code_adr_region_text.setValue(adirector_code_adr_region
				.getValue());
	}

	public void onChange$adirector_code_adr_region_text() {
		adirector_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null,
						adirector_code_adr_region_text.getValue(), alias)));
		adirector_code_adr_region
				.setSelecteditem(adirector_code_adr_region_text.getValue());
		...
		if (adirector_type_document.getValue() != null) {
			...
			if (adirector_type_document.getValue().equals("6")) {
				if (adirector_passport_date_registration.getValue() != null) {
					dt = new DateTime(
							adirector_passport_date_registration.getValue());
					dt = dt.plusYears(10);
					dt = dt.minusDays(1);
					adirector_passport_date_expiration.setValue(dt.toDate());
					// newcl.getDirector().setPassport_date_expiration(dt.toDate());
	...
	public void onChange$aaccountant_type_document_text() {
		...
		aaccountant_type_document
				.setSelecteditem(aaccountant_type_document_text.getValue());
	...
	public void onChange$aaccountant_type_document() {
		...
		aaccountant_type_document_text.setValue(aaccountant_type_document
				.getValue());
		change_aaccountant_type_document();
	}
	...
	public void change_aaccountant_type_document() {
		if (aaccountant_type_document.getValue().equals("1")) {
			...
			Events.postEvent(aaccountant_passport_serial, new Event(
					"onInitRender"));
			Events.postEvent(aaccountant_passport_number, new Event(
					"onInitRender"));
	...
	public void onCheck$aaccountant_pass_place_checkbox() {
		aaccountant_pass_place_region
				.setDisabled(aaccountant_pass_place_checkbox.isChecked());
		aaccountant_pass_place_region_text
				.setDisabled(aaccountant_pass_place_checkbox.isChecked());
		aaccountant_pass_place_distr
				.setDisabled(aaccountant_pass_place_checkbox.isChecked());
		aaccountant_pass_place_distr_text
				.setDisabled(aaccountant_pass_place_checkbox.isChecked());
	...
	public void onChange$aaccountant_pass_place_region() {
		...
		aaccountant_pass_place_region_text
				.setValue(aaccountant_pass_place_region.getValue());
	...
	public void onChange$aaccountant_pass_place_region_text() {
		...
		aaccountant_pass_place_region
				.setSelecteditem(aaccountant_pass_place_region_text.getValue());
		// newcl.getAccountant().setPass_place_region(aaccountant_pass_place_region.getValue());
	}

	public void onChange$aaccountant_pass_place_distr() {
		aaccountant_pass_place_distr_text.setValue(aaccountant_pass_place_distr
				.getValue());
		aaccountant_passport_place_registration
				.setText(aaccountant_pass_place_region.getText() + " "
						+ aaccountant_pass_place_distr.getText() + " " + "ИИБ");
	...
	public void onChange$aaccountant_pass_place_distr_text() {
		aaccountant_pass_place_distr
				.setSelecteditem(aaccountant_pass_place_distr_text.getValue());
		aaccountant_passport_place_registration
				.setText(aaccountant_pass_place_region.getText() + " "
						+ aaccountant_pass_place_distr.getText() + " " + "ИИБ");
		// newcl.getAccountant().setPassport_place_registration(
	...
	public void onChange$aaccountant_code_adr_region() {
		...
		aaccountant_code_adr_region_text.setValue(aaccountant_code_adr_region
				.getValue());
		newcl.setP_code_adr_distr(null);
		binder.loadAll();
	}
	...
	public void onChange$aaccountant_code_adr_region_text() {
		...
		aaccountant_code_adr_region
				.setSelecteditem(aaccountant_code_adr_region_text.getValue());
		...
		if (aaccountant_type_document.getValue() != null) {
			...
			if (aaccountant_type_document.getValue().equals("6")) {
				if (aaccountant_passport_date_registration.getValue() != null) {
					dt = new DateTime(
							aaccountant_passport_date_registration.getValue());
					dt = dt.plusYears(10);
					dt = dt.minusDays(1);
					aaccountant_passport_date_expiration.setValue(dt.toDate());
					// newcl.getAccountant().setPassport_date_expiration(dt.toDate());
	...
	public void onCheck$check_all_sap$fields_diff_wnd() {
		ZkUtils.checkAllRowsUnderSpecificColumn(ClientUtil.COLUMN_ATTR,
				ClientUtil.SAP_COLUMN, fields_diff_wnd$diff_rows,
				fields_diff_wnd$check_all_sap.isChecked());
	}

	public void onCheck$check_all_ebp$fields_diff_wnd() {
		ZkUtils.checkAllRowsUnderSpecificColumn(ClientUtil.COLUMN_ATTR,
				ClientUtil.EBP_COLUMN, fields_diff_wnd$diff_rows,
				fields_diff_wnd$check_all_ebp.isChecked());
	}

	public void onClick$btn_apply$fields_diff_wnd() {
		List<String> sapCheckedFields = ZkUtils.getCheckedRowsByAttribute(
				fields_diff_wnd$diff_rows, ClientUtil.SAP_COLUMN,
				ClientUtil.COLUMN_ATTR, ClientUtil.FIELD_ATTR);
		List<String> ebpCheckedFields = ZkUtils.getCheckedRowsByAttribute(
				fields_diff_wnd$diff_rows, ClientUtil.EBP_COLUMN,
				ClientUtil.COLUMN_ATTR, ClientUtil.FIELD_ATTR);

		ClientA fetchedClientFromSap = (ClientA) fields_diff_wnd$diff_grid
				.getAttribute(ClientUtil.SAP_CLIENT_ATTR);
		ClientA fetchedClientFromEbp = (ClientA) fields_diff_wnd$diff_grid
				.getAttribute(ClientUtil.EBP_CLIENT_ATTR);
		if (!addgrd.isVisible()) {
	...
	public void onCtrlKey$aj_soato() {
		Window soatoWnd = (Window) Executions.createComponents("soato.zul",
				null, null);
	...
	public void onChange$acl_activity_type_idValue() {
		acl_activity_type_id.setSelecteditem(acl_activity_type_idValue
				.getValue());
	...
	public void onCheck$type_radio_close1() {
		...
		fdate_close.setDisabled(type_radio_close1.getSelectedIndex() != 1
				&& type_radio_close1.getSelectedIndex() != 2);
	}
	...
	public void onChange$cl_activity_type_idValue() {
		cl_activity_type_id
				.setSelecteditem(cl_activity_type_idValue.getValue());
	...
	public void onChange$fp_code_adr_region_text() {
		...
		fp_code_adr_distr.setModel(new ListModelList(ClientDictionaries
				.getDistrByRegion(null, fp_code_adr_region.getValue(), alias)));
	}
	...
	public void onChange$director_code_citizenship() {
		director_code_citizenship_text.setValue(director_code_citizenship
				.getValue());
	}

	public void onChange$accountant_type_document() {
		accountant_type_document_text.setValue(accountant_type_document
				.getValue());
		// current.getAccountant().setType_document(accountant_type_document.getValue());
	}

	public void onChange$accountant_code_citizenship() {
		accountant_code_citizenship_text.setValue(accountant_code_citizenship
				.getValue());
	}
	...
	public void onChange$accountant_code_tax_org() {
		accountant_code_tax_org_text.setValue(accountant_code_tax_org
				.getValue());
	...
	public void onChange$aaccountant_code_country() {
		aaccountant_code_country_text.setValue(aaccountant_code_country
				.getValue());
		// newcl.getAccountant().setCode_country(aaccountant_code_country.getValue());
	}

	public void onChange$aaccountant_code_tax_org() {
		aaccountant_code_tax_org_text.setValue(aaccountant_code_tax_org
				.getValue());
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		if (parameter != null) {
			...
			System.out.println("HUMO parameter[0]: "+parameter[0]);
			logger.error("HUMO parameter[0]: "+parameter[0]);
		}
	...
	private void initDeltaMode() {
		...
		System.out.println("id_client[0]:"+id_client[0]);
		logger.error("id_client[0]:"+id_client[0]);
	...
	private void initCLientFromNibbd(String nibbdQueryOut) {
		...
		logger.error("initCLientFromNibbd   newcl.getSign_registr = "
				+ newcl.getSign_registr());
	...
	public void onSelect$cl_tabs() {
		...
		case 1:
			// initAccounts();
			// includeDeposits.setSrc("sd_books.zul?search_clients="
			// +current.getId_client() );
try{
//			String clientType = HumoCardsService.getClientType(ses_branch,
//					filter.getId_client(),un,pw,alias);

//			System.out.println("clientType:" + clientType);
//			System.out.println("ses_branch:" + ses_branch);
//			System.out.println("filter.getId_client():" + current.getBranch()
//					+ filter.getId_client());

			ISLogger.getLogger().error("ses_branch:"+ses_branch+" Id_client: "+filter.getId_client()+" un:"+un+" pw:"+pw+" alias:"+alias);
			
//			if (clientType.equals("J")) {

				includeCards.setSrc("humoJCards.zul?search_clients="
						+ current.getId_client() + "&ht=" + _pageSize);
//			}

//			else {

//				includeCards.setSrc("humoCards.zul?search_clients="
//						+ current.getId_client() + "&ht=" + _pageSize);

//			}
               }catch(Exception e){ ISLogger.getLogger().error("ClientError: "+CheckNull.getPstr(e));}
			// includeCards.setSrc("uz_card.zul?search_clients=" +
			// current.getId_client());
			break;
		case 2:
			// initSpecclt();
		...
		case 3:
			...
			includeTransfers.setSrc("dper_info.zul?search_clients="
					+ current.getId_client());
			/*
			...
			break;
		case 4:
			includeAccounts.setSrc("accounts.zul?search_clients="
					+ current.getId_client());
	...
	try{	
		logger.error("поиск 777"+" un:"+un+" alias:"+alias+" userId:"+userId+" ses_branch:"+ses_branch);
		...
		else {logger.error("Ошибка поиска");}
	}
	catch (Exception e) {
		logger.error("Ошибка поиска catch");
	...
	public void onClick$btn_get_ip() {
		...
		dp_wnd$incl_cp.setSrc(ClientUtil.CLIENT_IP_SRC
				+ "?action=createIndividualEnterpreneur");
		...
		if (currentListItem != null) {
			if (current == null || current.getBranch() == null
				...
				current = ClientAService.getItemByStringId(
						currentListItem.getBranch(),
						currentListItem.getId_client(), un, pw, alias);
				System.out.println("currentListItem.getId_client()888:"+currentListItem.getId_client());
				logger.error("currentListItem.getId_client():"+currentListItem.getId_client()+" un:"+un+" alias:"+alias+" userId:"+userId+" ses_branch:"+ses_branch);
			}
		}
		
		ISLogger.getLogger().error("current: "+ current);
	...
	public void onClick$act001_open() {
		...
		try {
			Messagebox.show(
					"вы действительно хотите выполнить действие: открыть?", "",
	...
	protected void openClient(int action) {
		...
		if (!newcl.getCode_type().equals("08")) {
			newcl.setJ_sign_trade(aj_sign_trade.isChecked() ? ClientUtil.CHECKBOX_Y
					: ClientUtil.CHECKBOX_N);
			newcl.setJ_small_business(aj_small_business.isChecked() ? ClientUtil.CHECKBOX_Y
					: ClientUtil.CHECKBOX_N);
			newcl.setCode_subject(newcl.getCode_type().equals("07") ? ClientUtil.CODE_SUBJECT_I
					: ClientUtil.CODE_SUBJECT_J);
			newcl.setJ_sign_dep_acc(aj_sign_dep_acc.isChecked() ? ClientUtil.CHECKBOX_Y
					: ClientUtil.CHECKBOX_N);
			boolean isNibbd = false;
			if ((mode != null && mode.equals(ClientUtil.MODE_NIBBD))
					|| action == 50) {
				isNibbd = true;
			}
		...
		Validator<ClientA> checkHandler = CheckClient.checkCleanClient(alias,
				ClientUtil.ACTION_OPEN);
		...
		logger.error("currentId client: "+currentId);
		System.out.println("currentId client: "+currentId);
	...
	void confirmAction(final int action) {
		...
		try {
			Messagebox.show("вы действительно хотите выполнить действие:"
					+ actionsMap.get(action) + "?", "", Messagebox.OK
	...
	private void executeAction(int action) {
		// Если тип ИП, то сделать конкатенацию имени
		if (current.getCode_type().equals(ClientUtil.CODE_TYPE_IP)) {
			String fullName = String.format("YATT %s %s %s",
					current.getP_family(), current.getP_first_name(),
					current.getP_patronymic());
			current.setName(fullName);
		}

		if (action == 4 || action == 19) {
			current.setJ_sign_trade(j_sign_trade.isChecked() ? ClientUtil.CHECKBOX_Y
					: ClientUtil.CHECKBOX_N);
			current.setJ_small_business(j_small_business.isChecked() ? ClientUtil.CHECKBOX_Y
					: ClientUtil.CHECKBOX_N);
			...
			if (action == ClientUtil.ACTION_CHANGE
					&& !CheckClient.isTaxNumberValid(
							current.getJ_number_tax_registration(), alias)) {
				alert("Неверный ИНН");
				return;
			}
	...
	public void initFromBpr(String id_client, String branch, String alias) {
		...
		if (id_client != null) {
			this.alias = alias;
			;
			logger.error("id_client HUMO:"+id_client);
			System.out.println("id_client HUMO:"+id_client);
	...
	public void compare(ClientA currentCustomer) {
		...
		fields_diff_wnd$diff_grid.setAttribute(ClientUtil.SAP_CLIENT_ATTR,
				fetchedFromSap);
		fields_diff_wnd$diff_grid.setAttribute(ClientUtil.EBP_CLIENT_ATTR,
				ebpClient);

		// ClientUtil.fillRowsIfThereChanges(currentCustomer, fetchedFromSap,
		// ebpClient, fields_diff_wnd$diff_rows);
		fields_diff_wnd.setVisible(fields_diff_wnd$diff_rows.getChildren()
				.size() > 0);
	...
	public boolean check_some_fields_to_open() {
		err_msg = "";
		if (!CheckNull.isEmpty(acode_country_value.getValue())
				&& CheckNull.isEmpty(acode_country.getValue())) {
			err_msg = "Неправильное значение в поле:  Код страна";
			return false;
		}
		if (!CheckNull.isEmpty(aregionValue.getValue())
				&& CheckNull.isEmpty(aj_region.getValue())) {
			err_msg = "Неправильное значение в поле:  Код региона";
			return false;
		}
		if (!CheckNull.isEmpty(adistrValue.getValue())
				&& CheckNull.isEmpty(aj_distr.getValue())) {
			err_msg = "Неправильное значение в поле:  Код района";
			return false;
		}
		if (!CheckNull.isEmpty(atax_orgValue.getValue())
				&& CheckNull.isEmpty(aj_code_tax_org.getValue())) {
			err_msg = "Неправильное значение в поле:  Код налоговой.";
			return false;
		}
		if (!CheckNull.isEmpty(aopfValue.getValue())
				&& CheckNull.isEmpty(aj_opf.getValue())) {
			err_msg = "Неправильное значение в поле:  Код ОПФ";
			return false;
		}
		if (!CheckNull.isEmpty(aformValue.getValue())
				&& CheckNull.isEmpty(acode_form.getValue())) {
			err_msg = "Неправильное значение в поле:  Код формы собственности";
			return false;
		}
		if (!CheckNull.isEmpty(asectorValue.getValue())
				&& CheckNull.isEmpty(aj_code_sector.getValue())) {
		...
		if (!CheckNull.isEmpty(aorgan_directValue.getValue())
				&& CheckNull.isEmpty(aj_code_organ_direct.getValue())) {
		...
		if (!CheckNull.isEmpty(ap_type_document_text.getValue())
				&& CheckNull.isEmpty(ap_type_document.getValue())) {
		...
		if (!CheckNull.isEmpty(ap_code_adr_distr_text.getValue())
				&& CheckNull.isEmpty(ap_code_adr_distr.getValue())) {
			err_msg = "Неправильное значение в поле:  Код района-местожителство";
			return false;
		}
		if (!CheckNull.isEmpty(abankValue.getValue())
				&& CheckNull.isEmpty(aj_code_bank.getValue())) {
		...
		// return false;
		// }
		if (!CheckNull.isEmpty(aiformValue.getValue())
				&& CheckNull.isEmpty(ai_form.getValue())) {
			err_msg = "Неправильное значение в поле:  Форма собственности ";
			return false;
		}
		if (!CheckNull.isEmpty(aisectorValue.getValue())
				&& CheckNull.isEmpty(ai_sector.getValue())) {
			err_msg = "Неправильное значение в поле:  Код сектора ";
			return false;
		}
		if (!CheckNull.isEmpty(aiorgan_directValue.getValue())
				&& CheckNull.isEmpty(ai_organ_direct.getValue())) {
			err_msg = "Неправильное значение в поле:  Код орган управления ";
			return false;
		}
		if (!CheckNull.isEmpty(aswift_idValue.getValue())
				&& CheckNull.isEmpty(aswift_id.getValue())) {
	...
	public boolean check_some_fields_to_edit() {
		err_msg = "";
		if (!CheckNull.isEmpty(code_country_value.getValue())
				&& CheckNull.isEmpty(code_country.getValue())) {
			err_msg = "Неправильное значение в поле:  Код страна";
			return false;
		}
		if (!CheckNull.isEmpty(regionValue.getValue())
				&& CheckNull.isEmpty(j_region.getValue())) {
			err_msg = "Неправильное значение в поле:  Код региона";
			return false;
		}
		if (!CheckNull.isEmpty(distrValue.getValue())
				&& CheckNull.isEmpty(j_distr.getValue())) {
			err_msg = "Неправильное значение в поле:  Код района";
			return false;
		}
		if (!CheckNull.isEmpty(tax_orgValue.getValue())
				&& CheckNull.isEmpty(j_code_tax_org.getValue())) {
			err_msg = "Неправильное значение в поле:  Код налоговой.";
			return false;
		}
		if (!CheckNull.isEmpty(opfValue.getValue())
				&& CheckNull.isEmpty(j_opf.getValue())) {
			err_msg = "Неправильное значение в поле:  Код ОПФ";
			return false;
		}
		if (!CheckNull.isEmpty(formValue.getValue())
				&& CheckNull.isEmpty(code_form.getValue())) {
			err_msg = "Неправильное значение в поле:  Код формы собственности";
			return false;
		}
		if (!CheckNull.isEmpty(sectorValue.getValue())
				&& CheckNull.isEmpty(j_code_sector.getValue())) {
			err_msg = "Неправильное значение в поле:  ОКЕД ";
			return false;
		}
		...
		if (!CheckNull.isEmpty(organ_directValue.getValue())
				&& CheckNull.isEmpty(j_code_organ_direct.getValue())) {
			err_msg = "Неправильное значение в поле:  Код орган управления";
			return false;
		}
		...
		if (!CheckNull.isEmpty(p_type_document_text.getValue())
				&& CheckNull.isEmpty(p_type_document.getValue())) {
			err_msg = "Неправильное значение в поле:  Тип документа ";
			return false;
		}
		...
		if (!CheckNull.isEmpty(p_code_adr_distr_text.getValue())
				&& CheckNull.isEmpty(p_code_adr_distr.getValue())) {
			err_msg = "Неправильное значение в поле:  Код района-местожителство";
			return false;
		}
		if (!CheckNull.isEmpty(bankValue.getValue())
				&& CheckNull.isEmpty(j_code_bank.getValue())) {
			err_msg = "Неправильное значение в поле:  Код банка";
			return false;
		}
		...
		// return false;
		// }
		if (!CheckNull.isEmpty(swift_idValue.getValue())
				&& CheckNull.isEmpty(swift_id.getValue())) {
			err_msg = "Неправильное значение в поле:  Код свифт";
			return false;
		}
	...
	public boolean check_some_fields_to_open_p() {
		err_msg = "";
		if (!CheckNull.isEmpty(ap_typeValue.getValue())
				&& CheckNull.isEmpty(ap_code_type.getValue())) {
		...
		if (!CheckNull.isEmpty(ap_code_country_value.getValue())
				&& CheckNull.isEmpty(ap_code_country.getValue())) {
		...
		if (!CheckNull.isEmpty(ap_code_capacity_text.getValue())
				&& CheckNull.isEmpty(ap_code_capacity.getValue())) {
			err_msg = "Неправильное значение в поле:  Код нетрудоспособности";
			return false;
		}
		if (!CheckNull.isEmpty(ap_bankValue.getValue())
				&& CheckNull.isEmpty(ap_code_bank.getValue())) {
			err_msg = "Неправильное значение в поле:  Код банка";
			return false;
		}
		if (!CheckNull.isEmpty(ap_class_creditValue.getValue())
				&& CheckNull.isEmpty(ap_code_class_credit.getValue())) {
			err_msg = "Неправильное значение в поле:  Код кредитоспособности";
			return false;
		}
		if (!CheckNull.isEmpty(ap_code_tax_org_text.getValue())
				&& CheckNull.isEmpty(ap_code_tax_org.getValue())) {
			err_msg = "Неправильное значение в поле:  Тип клиента";
			return false;
		}
	...
	// public static void onClick$btn_card2() throws Exception {
	//
	// HumoCardsService.createCards(un, pw, alias);
	// }

	public Map<String, String> getClientsInHashmap() throws SQLException {
		...
		try {
			...
			ps = c.prepareStatement("SELECT * FROM HUMO_NEW_EMP_GALLA c where exists (select 'x' from V_CLIENT_HUMO b WHERE b.branch = c.branch and b.id_client=c.client_id and b.state=2) and c.state_x='0'");
			rs = ps.executeQuery();

			while (rs.next()) {

				// if(rs.getString("branch").equals("00094")){
	...
	public Map<String, String> getFIZClientsInHashmap() throws SQLException {
		...
		try {
			...
			terminal = new ArrayList<RefData>();
			c = ConnectionPool.getConnection();
			ps = c.prepareStatement("SELECT * FROM HUMO_NEW_EMP_FIZIK c where exists (select 'x' from v_bfcustomer b WHERE b.branch = c.branch and b.id_client=c.client_id and b.state=2) and c.state='0'");
			rs = ps.executeQuery();
	...
	public static int insertNewCards(String client_id, String branch,
			String state, String err) {
		Connection c = null;
		int res = 0;
		PreparedStatement ps = null;
		try {
			c = ConnectionPool.getConnection();
			ps = c.prepareStatement("update HUMO_NEW_EMP_GALLA set state_x=?, err_x=?  where client_id=? and branch=?");
	...
	public static int insertFIZCards(String client_id, String branch,
			String state, String err) {
		Connection c = null;
		int res = 0;
		PreparedStatement ps = null;
		try {
			c = ConnectionPool.getConnection();
			ps = c.prepareStatement("update HUMO_NEW_EMP_FIZIK set state=?, err=?  where client_id=? and branch=?");
	...
	public void onClick$btn_getListAccountsByCard() throws Exception {

		Connection c = ConnectionPool.getConnection(alias);
		Map<String, String> hashMap = HumoCardsService.getAccountNoInHashmap();
		...
		try {
			...
			for (Map.Entry entry : hashMap.entrySet()) {
				...
				account_no = HumoCardsService.getListAccountsByCard(entry
						.getKey().toString(), issuingPortProxy, HUMO_BANK_C,
						HUMO_GROUPC);

				System.out.println("account_no:" + account_no);

				if (account_no != null) {
					res = HumoCardsService.insertAccountNo(c, account_no, entry
							.getKey().toString(), entry.getValue().toString());

					if (res == 1) {
						HumoCardsService.insertBfAccounts(c, account_no, entry
								.getValue().toString());
					} else {

						ISLogger.getLogger().error(
								"insert humo_cards не прошол");
					}

				} else {
					alert("нет соединение с HUMO");
					break;
				}
	...
	public void onClick$btn_agreNom() throws Exception {

		try {

			// Connection c=ConnectionPool.getConnection();
			//
			// PreparedStatement merchantPs =
			// c.prepareStatement("select acc,merchant from bf_globuz_merchants_all where merchant = ?");
			//
			// merchantPs.setString(1, "J04450013160901");
			// ResultSet rsMerch = merchantPs.executeQuery();
			// if(rsMerch.next()) {}
			//
			//
			//
			...
			// else{
			//
			// System.out.println("acc "+rsMerch.getString("acc"));
			// }
			//
			...
			Map<String, String> accounts = HumoCardsService
					.getAccountsInHashmap();

			for (Map.Entry entry : accounts.entrySet()) {

				String account_no = entry.getKey().toString();
				String client = entry.getValue().toString();
				// String card_acct=accounts.get("card_acct");
				// String tranz_acct=accounts.get("tranz_acct");

				String card = HumoCardsService.getPAN(
						BigInteger.valueOf(Long.parseLong(account_no)),
				...
				// System.out.println("card_acct:"+card_acct);
				// System.out.println("tranz_acct:"+tranz_acct);

			}

		} catch (Exception e) {

			ISLogger.getLogger().error("AccountNO" + e);
	...
	// c = ConnectionPool.getConnection();
	// ps =
	// c.prepareStatement("SELECT * FROM HUMO_NEW_EMP_FIZIK c where exists (select 'x' from v_bfcustomer b WHERE b.branch = c.branch and b.id_client=c.client_id and b.state=2) and c.state='0'");
	// rs = ps.executeQuery();
	//
	// if (rs.next()) {
	//
	...
	public void onUpload$humo(UploadEvent event) throws Exception {
		Connection c = null;
		PreparedStatement ps = null;

		try {
			ISLogger.getLogger().error("onUpload$humo");
			ISLogger.getLogger().error("SES_BRANCH: "+ses_branch);
			ISLogger.getLogger().error("un: "+un);
			ISLogger.getLogger().error("pw: "+pw);
			...
			Iterator<org.apache.poi.ss.usermodel.Row> iterator = datatypeSheet
					.iterator();

			while (iterator.hasNext()) {

				c = ConnectionPool.getConnection(un, pw, alias); ///ConnectionPool
				...
				if (currentCell != null) {
					...
					String type = GetCellValue(currentRow.getCell(0));
					String mfo = GetCellValue(currentRow.getCell(1));
					String client = GetCellValue(currentRow.getCell(2));
                    
                   
					ISLogger.getLogger().error("EXCELDAN: "+type+" "+mfo+" "+client);
					ISLogger.getLogger().error("SES_BRANCH: "+ses_branch);
					ISLogger.getLogger().error("un: "+un);
					ISLogger.getLogger().error("alias: "+alias);
					ISLogger.getLogger().error("userId: "+userId);
					
			
					
					if (!HumoCardsService.isExsistCard(c, type, mfo, client)) {

						if (GetCellValue(currentCell).matches("[0-9]+")) {
							 String account=GetCellValue(currentRow.getCell(4));
							 System.out.println("insert "+GetCellValue(currentCell));
							 System.out.println("account.substring(9, 17): "+account.substring(9, 17));
							 System.out.println("account: "+account);
							
							if (ses_branch.equals(mfo)) {
								System.out.println("PN:"+account.substring(17));
							if (pAss.get(type).equals(account.substring(17))){
								System.out.println("UN:"+account.substring(9, 17));
								if (client.equals(account.substring(9, 17))){
									
									
									
								if (HumoCardsService.checkAccount(account, alias)){
								ps = c.prepareStatement("INSERT INTO HUMO_CARD_OPEN (CARD_TYPE, BRANCH,CLIENT,ACCOUNT,STATE_N,NAME,range_id,branch_id,state_d,user_id) VALUES (?,?,?,?,?,?,?,?,?,?)");
								...
								try {
									...
									ISLogger.getLogger().error(
											"Счет не утвержден! Счет:" +account+" и уникалка:"+client+" МФО:"+mfo);
									alert("Счет не утвержден! Счет:" +account+" и уникалка:"+client+" МФО:"+mfo);
								}
								}else {
								
									ISLogger.getLogger().error(
											"Счет и уникалка клиента не совподает! Счет:" +account+" уникалка:"+client);
									alert("Счет и уникалка клиента не совподает! Счет:" +account+" и уникалка:"+client);
								}
							}else{
							
								ISLogger.getLogger().error(
										"Счет не совподает к типу карты: Счет:" +account+", уникалка:"+client+" и тип карты:"+type);
								alert("Счет не совподает к типу карты: Счет:" +account+", уникалка:"+client+" и тип карты:"+type);
							}
							} else {
								
								ISLogger.getLogger().error(
										"Клиент: " + client
												+ " принадлежит к МФО:" + mfo);
						...
						ISLogger.getLogger().error(
								type + " уже открывалось для " + client);
						System.out.println(type + " уже открывалось для "
								+ client);
						alert(type + " уже открывалось для " + client);
						System.out.println(type + " уже открывалось для "
								+ client);
			...
			try {
				// HumoCardsService.createCards(c,alias);
				
				Utils.close(ps);
				alert("Excel файл загружен!");

			} catch (Exception e) {
				ISLogger.getLogger().error("Ошибка при загрузки Excel " + e);
				e.printStackTrace();
			}
		}
	...
	private String GetCellValue(Cell currentCell) {
		return currentCell.getCellType() == 0 ? (currentCell
				.getNumericCellValue() + "").replace(".0", "") : currentCell
				.getStringCellValue();
	}

	public void onClick$openMassHumo() throws Exception {
		
		ISLogger.getLogger().error("Yangi karta ochish bosildi!");
		MassOpenCard mc = new MassOpenCard();
		System.out.println("userId:" + userId + "ses_branch:" + ses_branch);
		ISLogger.getLogger().error("userId:" + userId + "ses_branch:" + ses_branch);
		mc.openCard(userId, ses_branch);
		mc = null;

		MassOpenCard mc2 = new MassOpenCard();
		mc2.openCard(userId, ses_branch);
		mc2 = null;
		// onClick$btn_agreNom();
		onClick$btn_psevdapan();
		HumoCardsService.replaceCardToReal();
		ISLogger.getLogger().error("Все карты открылся!");
		alert("Все карты открылся!");
	}

	public void onClick$openMassHumoRenew() throws Exception {
		MassOpenCardRenew2 mc = new MassOpenCardRenew2();
		mc.openCard(userId, ses_branch,alias);
		mc = null;

		alert("Все карты открылся!");
	}
	
	public void onClick$testReplace() throws Exception {
		MassOpenCardRenew2 mc = new MassOpenCardRenew2();
		mc.openCard(userId, ses_branch,alias);
		mc = null;
...
//	public void onClick$openMassHumoRenewFizCard() throws Exception {
//		MassOpenCardRenewFizCard mc = new MassOpenCardRenewFizCard();
//		mc.openCard();
//		mc = null;
//
//		MassOpenCardRenewFizCard mc2 = new MassOpenCardRenewFizCard();
//		mc2.openCard();
//		mc2 = null;
//		// onClick$btn_agreNom();
//		onClick$btn_psevdapan();
...
//	}
	...
	public void onUpload$humoCardsRenew(UploadEvent event) throws Exception {
		Connection c = null;
		PreparedStatement ps = null;

		try {
			c = ConnectionPool.getConnection(un, pw, alias);
			ps = c.prepareStatement("INSERT INTO HUMO_CARD_OPEN_RENEW (CARD_TYPE, BRANCH,CLIENT,ACCOUNT,STATE_N,NAME,range_id,branch_id,state_d,user_id) VALUES (?,?,?,?,?,?,?,?,?,?)");
			...
			while (iterator.hasNext()) {
				...
				if (currentCell != null) {
					...
					if (!HumoCardsService.isExsistCardRenew(c, type, mfo,
							client)) {
						...
						if (GetCellValue(currentCell).matches("[0-9]+")) {
							...
							ps.setString(2, mfo);
							ps.setString(3, client);
							ps.setString(4, GetCellValue(currentRow.getCell(4)));
							ps.setString(5, "0");
							ps.setString(6, GetCellValue(currentRow.getCell(3)));
							ps.setString(7, "777");
							ps.setString(8, "777");
							ps.setString(9, "777");
							ps.setInt(10, userId);
	...
	public void onUpload$testExcel(UploadEvent event) throws Exception {
		Connection c = null;
		PreparedStatement ps = null;
	...
	// public static int insertTranzAccAndAccountNo(String account_no) {
	// Connection c = null;
	// int res=0;
	...
	// c = ConnectionPool.getConnection();
	// ps =
	// c.prepareStatement("insert into bf_empc_accounts a (a.account_no, a.card_acct,a.tranz_acct, a.created_date,a.ab_expirity) values (?, ?, ?, ?, ?)");
	// psAcc=c.prepareStatement("select tranz_acct from humo_cards where account_no=? ");
	// psAcc.setString(1, account_no);
	// rsAcc=psAcc.executeQuery();
	//
	// if(rsAcc.next()){
	//
	// ps.setString(1, account_no);
	// ps.setString(2, rsAcc.getString(1));
	// ps.setString(3, rsAcc.getString(1));
	...
	// public void onClick$btn_pere() throws SQLException, Exception {
	//
	//
	// TclientService tcs= new TclientService();
	//
	//
	// tcs.newAgreementHumo(ConnectionPool.getConnection(), alias,
	// "00394", "99012539",
	// "1111", new Customer(), "00000185", "22618000999012539700", "222S");
	// ISLogger.getLogger().info("VIZVAL NEW AGREEMENT");
	//
	// }

	public void onClick$setStatus() throws Exception {
		Connection c = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		try {
			...
			Map<String, String> hashMap = HumoCardsService.getListCard();

			for (Map.Entry entry : hashMap.entrySet()) {

				CardStatus cardStatus = HumoCardsService.getCardStatus(entry
						.getKey().toString(), issuingPortProxy, bankC, groupC);

				insertCardStatus(entry.getKey().toString(), cardStatus);
			...
			if (c != null) {
				...
				ConnectionPool.close(c);
				ISLogger.getLogger().info("CONNECTION CLOSED");
	...
	public void insertCardStatus(
			String psevdaPAN, CardStatus cardStatus) throws SQLException {
		Connection c=null;
		PreparedStatement ps=null;
		try {
			c = ConnectionPool.getConnection();
			    ps = c.prepareStatement("update humo_cards set STATUS1=?,STATUS2=?, STOP_CAUSE=?,update_status=? where card=?");
				ps.setString(1, cardStatus.getStatus1());
				ps.setString(2, cardStatus.getStatus2());
				ps.setString(3, cardStatus.getStop_cause());
				ps.setDate(4,  new java.sql.Date(new Date().getTime()));
				ps.setString(5, psevdaPAN);

				ps.executeUpdate();
				c.commit();
//				System.out.println("card: " + psevdaPAN + "STATUS1: "
//						+ cardStatus.getStatus1() + " STATUS2: "
//						+ cardStatus.getStatus2() + " STOP_CAUSE: "
//						+ cardStatus.getStop_cause());
//				ISLogger.getLogger().info(
//						"card: " + psevdaPAN + "STATUS1: "
//								+ cardStatus.getStatus1() + " STATUS2: "
//								+ cardStatus.getStatus2() + " STOP_CAUSE: "
//								+ cardStatus.getStop_cause());
			...
			try {
				if (c != null)
					...
					ISLogger.getLogger().error("ROLLBACK");
				c.rollback();
			} catch (Exception ex) {
			}
	...
	public void onClick$DataUpload() throws Exception {

		DataUpload.dataUpload();
	}

	public void onClick$DataDownload() throws Exception {

		
if (ConnectionPool.getValue("humo_host_term").equals("")){
			
	        System.out.println(ConnectionPool.getValue("humo_host_term"));
			System.out.println("humo_host_term null");
		}
		else{
			 System.out.println(ConnectionPool.getValue("humo_host_term"));
			System.out.println("humo_host_term exsist");
		}
		DataDownload.dataDownload();
	}
	public void onClick$openMomentCard() throws Exception {
