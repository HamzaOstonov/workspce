...
public class Customer
{
	...
	{
		this.p_family = p_family.toUpperCase();
	}
	...
	{
		this.p_first_name = p_first_name.toUpperCase();
	}
	...
	{
		this.p_patronymic = p_patronymic.toUpperCase();
	}
	...
	public String toString() {
		return "Customer [id="
				...
				+ (id_client != null ? "id_client=" + id_client + ",/n " : "")
				+ (name != null ? "name=" + name + ",/n " : "")
				+ (code_country != null ? "code_country=" + code_country
						+ ",/n " : "")
				+ (code_type != null ? "code_type=" + code_type + ",/n " : "")
				+ (code_resident != null ? "code_resident=" + code_resident
						+ ",/n " : "")
				+ (code_subject != null ? "code_subject=" + code_subject
						+ ",/n " : "")
				+ (code_product != null ? "code_product=" + code_product
						+ ",/n " : "")
				+ "sign_registr="
				+ sign_registr
				+ ",/n "
				+ (code_form != null ? "code_form=" + code_form + ",/n " : "")
				+ (date_open != null ? "date_open=" + date_open + ",/n " : "")
				+ (date_close != null ? "date_close=" + date_close + ",/n "
						: "")
				+ "state="
				+ state
				+ ",/n "
				+ (p_birthday != null ? "p_birthday=" + p_birthday + ",/n "
						: "")
				+ (p_post_address != null ? "p_post_address=" + p_post_address
						+ ",/n " : "")
				+ (p_passport_type != null ? "p_passport_type="
						+ p_passport_type + ",/n " : "")
				+ (p_passport_serial != null ? "p_passport_serial="
						+ p_passport_serial + ",/n " : "")
				+ (p_passport_number != null ? "p_passport_number="
						+ p_passport_number + ",/n " : "")
				+ (p_passport_place_registration != null ? "p_passport_place_registration="
						+ p_passport_place_registration + ",/n "
						: "")
				+ (p_passport_date_registration != null ? "p_passport_date_registration="
						+ p_passport_date_registration + ",/n "
						: "")
				+ (p_code_tax_org != null ? "p_code_tax_org=" + p_code_tax_org
						+ ",/n " : "")
				+ (p_number_tax_registration != null ? "p_number_tax_registration="
						+ p_number_tax_registration + ",/n "
						: "")
				+ (p_code_bank != null ? "p_code_bank=" + p_code_bank + ",/n "
						: "")
				+ (p_code_class_credit != null ? "p_code_class_credit="
						+ p_code_class_credit + ",/n " : "")
				+ (p_code_citizenship != null ? "p_code_citizenship="
						+ p_code_citizenship + ",/n " : "")
				+ (p_birth_place != null ? "p_birth_place=" + p_birth_place
						+ ",/n " : "")
				+ (p_code_capacity != null ? "p_code_capacity="
						+ p_code_capacity + ",/n " : "")
				+ (p_capacity_status_date != null ? "p_capacity_status_date="
						+ p_capacity_status_date + ",/n " : "")
				+ (p_capacity_status_place != null ? "p_capacity_status_place="
						+ p_capacity_status_place + ",/n " : "")
				+ (p_num_certif_capacity != null ? "p_num_certif_capacity="
						+ p_num_certif_capacity + ",/n " : "")
				+ (p_phone_home != null ? "p_phone_home=" + p_phone_home
						+ ",/n " : "")
				+ (p_phone_mobile != null ? "p_phone_mobile=" + p_phone_mobile
						+ ",/n " : "")
				+ (p_email_address != null ? "p_email_address="
						+ p_email_address + ",/n " : "")
				+ (p_pension_sertif_serial != null ? "p_pension_sertif_serial="
						+ p_pension_sertif_serial + ",/n " : "")
				+ (p_code_gender != null ? "p_code_gender=" + p_code_gender
						+ ",/n " : "")
				+ (p_code_nation != null ? "p_code_nation=" + p_code_nation
						+ ",/n " : "")
				+ (p_code_birth_region != null ? "p_code_birth_region="
						+ p_code_birth_region + ",/n " : "")
				+ (p_code_birth_distr != null ? "p_code_birth_distr="
						+ p_code_birth_distr + ",/n " : "")
				+ (p_type_document != null ? "p_type_document="
						+ p_type_document + ",/n " : "")
				+ (p_passport_date_expiration != null ? "p_passport_date_expiration="
						+ p_passport_date_expiration + ",/n "
						: "")
				+ (p_code_adr_region != null ? "p_code_adr_region="
						+ p_code_adr_region + ",/n " : "")
				+ (p_code_adr_distr != null ? "p_code_adr_distr="
						+ p_code_adr_distr + ",/n " : "")
				+ (p_inps != null ? "p_inps=" + p_inps + ",/n " : "")
				+ (p_family != null ? "p_family=" + p_family + ",/n " : "")
				+ (p_first_name != null ? "p_first_name=" + p_first_name
						+ ",/n " : "")
				+ (p_patronymic != null ? "p_patronymic=" + p_patronymic
						+ ",/n " : "")
				+ (tieto_customer_id != null ? "tieto_customer_id="
						+ tieto_customer_id + ",/n " : "")
				+ (head_customer_id != null ? "head_customer_id="
						+ head_customer_id + ",/n " : "")
				+ (acode_tel != null ? "acode_tel=" + acode_tel + ",/n " : "")
				+ (R_CITY != null ? "R_CITY=" + R_CITY + ",/n " : "")
				+ (R_STREET != null ? "R_STREET=" + R_STREET + ",/n " : "")
				+ (R_E_MAILS != null ? "R_E_MAILS=" + R_E_MAILS + ",/n " : "")
				+ (R_MOB_PHONE != null ? "R_MOB_PHONE=" + R_MOB_PHONE + ",/n "
						: "")
				+ (R_PHONE != null ? "R_PHONE=" + R_PHONE + ",/n " : "")
				+ (R_CNTRY != null ? "R_CNTRY=" + R_CNTRY + ",/n " : "")
				+ (ISSUED_BY != null ? "ISSUED_BY=" + ISSUED_BY + ",/n " : "")
				+ (PERSON_CODE != null ? "PERSON_CODE=" + PERSON_CODE : "")
				+ "]";
	}
