...
public class HumoServiceModel implements Serializable
{
    ...
    public HumoServiceModel() {
    }
    
    public HumoServiceModel(final Double id, final Double prots_name, final Double descripsion, final Double state) {
        this.id = id;
