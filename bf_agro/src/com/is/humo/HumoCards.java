...
public class HumoCards implements Serializable {
    ...
    public HumoCards( String client, String client_b, String branch, String card, String status1, String status2, Date expiry1, Date expirity2, String renew, Date renew_date, String card_name, String mc_name, String m_name, String stop_cause, String renewed_card, int design_id, String instant,String real_card,String tranz_acct,String created_date) {
