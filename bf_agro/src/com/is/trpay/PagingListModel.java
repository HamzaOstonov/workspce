...
@Override
protected List<TrPay> getPageData(int itemStartNumber, int pageSize, Object fl,String alias ) {
    TrPayFilter fc;
    if(fl !=null){
        fc = (TrPayFilter)fl;
}else{
    ...
    innerList_ = TrPayService.getTrPaysFl(itemStartNumber, pageSize,fc, alias );
