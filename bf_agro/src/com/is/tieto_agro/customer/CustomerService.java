...
public class CustomerService
{
	...
	{
		return com.is.utils.RefDataService.getRefData("select code data, name label from BF_visa_CARD_SETTING where flag_user_view='1' and FLAG_CLIENT_TYPE='" + client_type + "' order by code", branch);
	}
	...
	public static link get_link_ho(String Client_id, String Branch, String alias)
	{
		...
		try
		{
			...
			PreparedStatement ps = c.prepareStatement("select t.id id, t.branch branch, t.bank_customer_id bank_id, t.tieto_customer_id tieto_id, t.head_customer_id head_id, t.cur_acc cur_acc from BF_VISA_CUSTOMERS t where t.head_customer_id=? and t.branch=?");
	...
	*/
	...
	public static int getCount(CustomerFilter filter, String alias)
	{
		...
		sql.append("SELECT count(*) ct FROM v_bfcustomer and rownum < 1000");
		if (flFields.size() > 0)
		{
	...
	public static void Tc(TietoCustomer tietocustomer, String alias)
	{
		...
		{
			c = ConnectionPool.getConnection(alias);
			PreparedStatement ps = c.prepareStatement("UPDATE BF_VISA_CUSTOMERS SET bank_customer_id=?, head_customer_id=? WHERE branch=? and tieto_customer_id=?");
	...
	public static TietoCustomer create(TietoCustomer tietocustomer, String alias)
	{
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("INSERT INTO BF_VISA_CUSTOMERS (branch, bank_customer_id, tieto_customer_id, head_customer_id ) VALUES (?,?,?,?)");
	...
	public static void create_lnk(String branch, String HO_id, String branch_id, String tieto_id, String cur_acc, String alias)
	{
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("INSERT INTO BF_VISA_CUSTOMERS (id,branch, bank_customer_id, tieto_customer_id, head_customer_id, cur_acc) VALUES (seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?,?,?)");
	...
	public static void update_lnk_ti_by_ho(String branch, String HO_id, String tieto_id, String alias)
	{
		...
		if (get_link_ho(HO_id, branch, alias) == null)
		{
			...
			{
				c = ConnectionPool.getConnection(alias);
				ps = c.prepareStatement("insert into BF_VISA_CUSTOMERSs (id, tieto_customer_id, branch, head_customer_id) values (seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?)");
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set tieto_customer_id = ? where branch = ? and head_customer_id = ?");
	...
	public static void update_lnk_ti_by_br(String branch, String br_id, String tieto_id, String alias)
	{
		...
		if (get_link_branch(br_id, branch, alias) == null)
		{
			...
			{
				c = ConnectionPool.getConnection(alias);
				ps = c.prepareStatement("insert into BF_VISA_CUSTOMERS (id, tieto_customer_id, branch, bank_customer_id) values(seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?)");
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set tieto_customer_id = ? where branch = ? and bank_customer_id = ?");
	...
	public static Res update_lnk_ho_by_ti(String branch, String ho_id, String tieto_id, String alias)
	{
		...
		if (get_link_tieto(tieto_id, branch, alias) == null)
		{
			...
			{
				c = ConnectionPool.getConnection(alias);
				ps = c.prepareStatement("insert into BF_VISA_CUSTOMERS (id,head_customer_id, branch, tieto_customer_id) values(seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?)");
				...
				ps.executeUpdate();
				c.commit();
				res = new Res(1, "Inserted into BF_VISA_CUSTOMERS...");
			}
			catch (Exception e)
			{
				LtLogger.getLogger().error(CheckNull.getPstr(e));
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set head_customer_id = ? where branch = ? and tieto_customer_id = ?");
			...
			ps.executeUpdate();
			c.commit();
			res = new Res(1, "updated BF_VISA_CUSTOMERS...");
		}
		catch (Exception e)
		{
			LtLogger.getLogger().error(CheckNull.getPstr(e));
	...
	public static Res update_lnk_ho_by_br(String branch, String ho_id, String br_id, String alias)
	{
		...
		if (get_link_branch(br_id, branch, alias) == null)
		{
			...
			{
				c = ConnectionPool.getConnection(alias);
				ps = c.prepareStatement("insert into BF_VISA_CUSTOMERS (id,head_customer_id, branch, bank_customer_id" + (tieto != null ? ", tieto_customer_id" : "") + ") values(seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?" + (tieto != null ? ",?" : "") + ")");
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set head_customer_id = ?" + (tieto != null ? ", tieto_customer_id='" + tieto + "'" : "") + " where branch = ? and bank_customer_id = ?");
	...
	public static Res update_lnk_br_by_ti(String branch, String br, String tieto_id, String alias)
	{
			...
			try
			{
				...
				ps = c.prepareStatement("insert into BF_VISA_CUSTOMERS" +
						"(id, bank_customer_id, branch, tieto_customer_id" + (ho == null ? "" : ", head_customer_id") + ") " +
							"values (seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?"
						+ (ho == null ? "" : ",?") + ")");
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set bank_customer_id = ?" + (ho == null ? "" : ", head_customer_id = '" + ho + "'") + " where branch = ? and tieto_customer_id = ?");
	...
	public static Res update_lnk_br_by_ho(String branch, String br, String ho, String alias)
	{
		...
		if (get_link_ho(ho, branch, alias) == null)
		{
			...
			{
				c = ConnectionPool.getConnection(alias);
				ps = c.prepareStatement("insert into BF_VISA_CUSTOMERS(id,bank_customer_id, branch, head_customer_id" + (tieto != null ? ", tieto_customer_id" : "") + ") values (seq_BF_VISA_CUSTOMERS.Nextval, ?,?,?" + (tieto != null ? ",?" : "") + ")");
		...
		{
			c = ConnectionPool.getConnection(alias);
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set bank_customer_id = ?" + (tieto != null ? ", tieto_customer_id = '" + tieto + "'" : "") + " where branch = ? and head_customer_id = ?");
	...
	public static TietoCustomer getTietoCustomer(TietoCustomer tietocustomerId, String alias)
	{
		...
		{
			c = ConnectionPool.getConnection(alias);
			PreparedStatement ps = c.prepareStatement("SELECT * FROM BF_VISA_CUSTOMERS WHERE branch=? and tieto_customer_id=?");
			...
			else
			{
				...
				ps = c.prepareStatement("SELECT distinct tieto_customer_id,head_customer_id FROM BF_VISA_CUSTOMERS WHERE tieto_customer_id=?");
	...
	public static TietoCustomer getTietoCustomer_by_head(String head_customerId, String branch_id, String alias)
	{
		...
		{
			c = ConnectionPool.getConnection(alias);
			PreparedStatement ps = c.prepareStatement("SELECT * FROM BF_VISA_CUSTOMERS WHERE branch=? and head_customer_id=?");
			ps.setString(1, branch_id);
	...
	public static String get_BR_by_tieto(String tieto_id, String alias)
	{
		...
		{
			c = ConnectionPool.getConnection(alias);
			PreparedStatement ps = c.prepareStatement("Select * From BF_VISA_CUSTOMERS T Where T.TIETO_CUSTOMER_ID = ? ");
			ps.setString(1, tieto_id);
			ResultSet rs = ps.executeQuery();
			if (rs.next())
			{
	...
	public static String get_contract(String branch, String card_code, String alias)
	{
		...
		try
		{
			...
			if (rs.next()) res = new String(rs.getString(1));
	...
	public static Res update_lnk_set_acc(String un, String pwd, String branch, String br_id, GlobuzAccount acc, String alias, agroBank.IssuingWS.IssuingPortProxy issuingPortProxy)
	{
		Res res  = new Res();
		Connection c = null;
		PreparedStatement ps = null;
		try
		{
			...
			ps = c.prepareStatement("update BF_VISA_CUSTOMERS set cur_acc = ? where branch = ? and bank_customer_id = ?");
	...
	public static Res Get_acc_hole(String acc_bal, String first, String last, String client_id, String branch, String alias)
	{
		...
		try
		{
			...
			/*
			PreparedStatement ps = c.prepareStatement("select LPAD(TO_CHAR(MAX(TO_NUMBER(t.id_order))+1),3,'0')res, MAX(TO_NUMBER(t.id_order))+1 val from tietoAccount t " +
					"where " +
					"t.client = ? " +
					"and t.branch = ? " +
					"and t.acc_bal = ? " +
