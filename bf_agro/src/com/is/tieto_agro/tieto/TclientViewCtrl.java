...
import com.is.tieto_agro.customer.CustomerFilter;
import com.is.tieto_agro.customer.CustomerService;
import com.is.tieto_agro.customer.CustomerService.link;
import com.is.tieto_agro.customer.TietoCustomer;
...
public class TclientViewCtrl extends GenericForwardComposer
{
	...
	private com.is.tieto_agro.customer.PagingListModel CustPagingListModel;
	...
	private agroBank.IssuingWS.IssuingPortProxy pp = null;
	...
	public void printp(TrPay trp, String report_file)
	{
		...
		params.put("ACCDOPER1", com.is.tieto_agro.tieto.TclientService.getkass_acc(branch, alias));
	...
	public void onClick$btn_add$addwnd()
	{
		...
		TietoCustomer tc;
		tc = com.is.tieto_agro.customer.CustomerService.getTietoCustomer(current.getClient(), branch, alias);
	}
