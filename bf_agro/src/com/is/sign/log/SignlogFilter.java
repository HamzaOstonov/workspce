...
public class SignlogFilter implements Serializable {
    ...
    public SignlogFilter() {
		super();
    }

	public SignlogFilter(Long id, Date dttime, int group_id, int deal_id, int action_id, Long object_id, String sign_text, String sign_data, int key_type, String key_code, String key_sn, String branch, int user_id, String username, String scheme, int state, String err_msg) {
		super();
		this.id = id;
		this.dttime = dttime;
