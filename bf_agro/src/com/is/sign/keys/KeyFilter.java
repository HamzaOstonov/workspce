...
public class KeyFilter implements Serializable {
	...
	public KeyFilter(int key_type, String key_code, String key_sn, String key_certn, String version, String signature_algoritm, Long key_size, String issuer, String pkey, Long sign_failure, Date key_expired, Date activate_date, Date deactivate_date, String branch, int emp_id, int state, String user_branch, int user_id, String user_name) {
		super();
