...
public class UFXMsgUpdStatus {
	@JsonProperty("MsgId")
	private String msgId;
	@JsonProperty("Source")
	private Source SourceObject;
	@JsonProperty("MsgData")
	private MsgDataUpdStatus MsgDataObject;
	...
	@JsonProperty("MsgData")
	public MsgDataUpdStatus getMsgDataReq() {
	...
	@JsonProperty("MsgData")
	public void setMsgDataReq(MsgDataUpdStatus MsgDataObject) {
