...
public class UFXMsgInqContractResp {
	...
	private MsgDataInqContractResp MsgDataObject;
	...
	@JsonProperty("MsgData")
	public MsgDataInqContractResp getMsgDataReq() {
	...
	@JsonProperty("MsgData")
	public void setMsgDataReq(MsgDataInqContractResp MsgDataObject) {
