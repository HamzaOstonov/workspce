...
public class UFXMsgPayAccResp {
	 ...
	 private MsgDataPayAccResp MsgDataObject;
	 ...
	 @JsonProperty("MsgData")
	 public MsgDataPayAccResp getMsgDataReq() {
	...
	public String getResp_text() {
	 ...
	 @JsonProperty("MsgData")
	 public void setMsgDataReq(MsgDataPayAccResp MsgDataObject) {
