...
public class UFXMsgAddContractCardRes {
	 ...
	 private MsgDataAddContractCard MsgDataObject;
	 ...
	 public UFXMsgAddContractCardRes() {
		 //this.direction="Rq";
	 ...
	 @JsonProperty("MsgData")
	 public MsgDataAddContractCard getMsgDataReq() {
	...
	public String getResp_text() {
	 ...
	 @JsonProperty("MsgData")
	 public void setMsgDataReq(MsgDataAddContractCard MsgDataObject) {
