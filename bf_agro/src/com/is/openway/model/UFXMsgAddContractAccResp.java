...
public class UFXMsgAddContractAccResp {
	 ...
	 private MsgDataAddContractResp MsgDataObject;
	 ...
	 public UFXMsgAddContractAccResp() {
		 this.direction="Rq";
	 ...
	 @JsonProperty("MsgData")
	 public MsgDataAddContractResp getMsgDataReq() {
	...
	public String getResp_text() {
	 ...
	 @JsonProperty("MsgData")
	 public void setMsgDataReq(MsgDataAddContractResp MsgDataObject) {
