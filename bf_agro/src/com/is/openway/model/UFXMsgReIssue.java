...
public class UFXMsgReIssue {
	@JsonProperty("MsgId")
	private String msgId;
	@JsonProperty("Source")
	private Source SourceObject;
	@JsonProperty("MsgData")
	private MsgDataReIssue MsgDataObject;
	...
	@JsonProperty("MsgData")
	public MsgDataReIssue getMsgDataReq() {
	...
	@JsonProperty("MsgData")
	public void setMsgDataReq(MsgDataReIssue MsgDataObject) {
