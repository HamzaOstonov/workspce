...
public class Application {
	...
	@JsonProperty("Data")
	 private DataAdd DataObject;
	@JsonProperty("DataRs")
	 private DataRs DataRsObject;
	@JsonProperty("Status")
	...
	@JsonProperty("Data")
	 public DataAdd getData() {
	  return DataObject;
	 }
	 @JsonProperty("DataRs")
		public DataRs getDataRsObject() {
			return DataRsObject;
		}
	 @JsonProperty("Status")
	public Status getStatusObject() {
	 ...
	 public void setResultDtls(ResultDtls ResultDtlsObject) {
	  this.ResultDtlsObject = ResultDtlsObject;
		...
		@JsonProperty("Data")
	 public void setData(DataAdd DataObject) {
	  this.DataObject = DataObject;
	 }
	 

	 @JsonProperty("DataRs")
	public void setDataRsObject(DataRs dataRsObject) {
