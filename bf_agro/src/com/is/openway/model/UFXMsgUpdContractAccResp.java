...
public class UFXMsgUpdContractAccResp {
	 ...
	 private MsgDataUpdContractResp MsgDataObject;
	 ...
	 public UFXMsgUpdContractAccResp() {
		 this.direction="Rq";
	 ...
	 @JsonProperty("MsgData")
	 public MsgDataUpdContractResp getMsgDataReq() {
	...
	public String getResp_text() {
	 ...
	 @JsonProperty("MsgData")
	 public void setMsgDataReq(MsgDataUpdContractResp MsgDataObject) {
