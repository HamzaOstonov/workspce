...
public class VisaOnusRecord implements Serializable{
    ...
    public VisaOnusRecord() {
    }

    public VisaOnusRecord(Long id, Long empc_file_id, int state_id, String record_type, Long line_number, String client, String card_acct, String accnt_ccy, String card, String slip_nr, String ref_number, Date tran_date_time, Date rec_date, Date post_date, String deal_desc, String tran_type, String deb_cred, String tran_ccy, Long tran_amt, Long accnt_amt, String terminal, String mcc_code, String merchant, String abvr_name, String country, String city, Long proc_id, Long internal_no, Long product, String iss_mfo, String term_id, String tranz_acct) {
        this.id = id;
    ...
    public VisaOnusRecord(Long id, int state_id, String slip_nr, Long tran_amt, String mcc_code, String merchant, String term_id) {
        this.id = id;
        this.state_id = state_id;
        this.slip_nr = slip_nr;
        this.tran_amt = tran_amt;
	...
	public String toString() {
		return "EmpcExptRecord ["
				...
				+ (empc_file_id != null ? "empc_file_id=" + empc_file_id
						+ ",/n " : "")
				+ (state_id != 0 ? "state_id=" + state_id + ",/n " : "")
