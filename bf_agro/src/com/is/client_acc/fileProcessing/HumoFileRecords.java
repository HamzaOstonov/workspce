...
String agreement_numver;
String dbo_closed_dt;
String doc_fio;
String bank_account;
String pinfl;
String nciid;
...
public String getAgreement_numver() {
	return agreement_numver;
}
public void setAgreement_numver(String agreement_numver) {
	this.agreement_numver = agreement_numver;
}
public String getDbo_closed_dt() {
	return dbo_closed_dt;
}
public void setDbo_closed_dt(String dbo_closed_dt) {
	this.dbo_closed_dt = dbo_closed_dt;
}
public String getDoc_fio() {
	return doc_fio;
}
public void setDoc_fio(String doc_fio) {
...
public Long getClientacc_file_id() {
	return clientacc_file_id;
}

public void setClientacc_file_id(Long clientacc_file_id) {
	this.clientacc_file_id = clientacc_file_id;
}
