...
public class SwiftBufferFilter {
    ...
    private Double deal_id;
    private Double parent_group_id;
    private Long parent_id;
    private Long batch_id;
    private String file_name;

    public SwiftBufferFilter() {
    	super();
    }

	public SwiftBufferFilter(String branch, Long id, String message_type,
			...
			Date insert_date, Double state, Double deal_id,
			Double parent_group_id, Long parent_id, Long batch_id,
			String file_name) {
		super();
		this.branch = branch;
		this.id = id;
	...
	public Double getDeal_id() {
		return deal_id;
	}

	public void setDeal_id(Double deal_id) {
		this.deal_id = deal_id;
	}

	public Double getParent_group_id() {
		return parent_group_id;
	}

	public void setParent_group_id(Double parent_group_id) {
		this.parent_group_id = parent_group_id;
	}
