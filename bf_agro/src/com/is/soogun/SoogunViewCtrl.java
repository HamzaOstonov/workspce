...
public class SoogunViewCtrl extends GenericForwardComposer {
	...
	public Soogun current = new Soogun();
	private Soogun filter = new Soogun();
	

	public Soogun getCurrent() {
		return current;
	}

	public void setCurrent(Soogun current) {
		this.current = current;
	}

	public Soogun getFilter() {
		return filter;
	}

	public void setFilter(Soogun filter) {
		this.filter = filter;
	}
