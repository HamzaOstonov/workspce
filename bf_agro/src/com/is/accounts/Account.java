...
public class Account implements Serializable {
    static final long serialVersionUID = 123456743543546L;
	...
	private String sout_str;
	private String sin_str;
	private String dt_str;
	private String ct_str;
	private String s_in_tmp_str;
	private String s_out_tmp_str;
	private String dt_tmp_str;
	private String ct_tmp_str;
	...
	public Account(String branch, String id, String acc_bal, String currency,
			...
			String bal, Long sign_registr, Long s_in, Long s_out, Long dt,
			Long ct, Long s_in_tmp, Long s_out_tmp, Long dt_tmp, Long ct_tmp,
			Date l_date, Date date_open, Date date_close, Long acc_group_id,
			Long state, Long kod_err, String file_name, String state_desc,String  close_sgn) {
		super();
		this.branch = branch;
		this.id = id;
		this.acc_bal = acc_bal;
	...
	public String getSout_str() {
		return nf.format(Double.valueOf(s_out==null?0:s_out)/100);
	}

	public String getSin_str() {
		return nf.format(Double.valueOf(s_in==null?0:s_in)/100);
	}

	public String getDt_str() {
		return nf.format(Double.valueOf(dt==null?0:dt)/100);
	}

	public String getCt_str() {
		return nf.format(Double.valueOf(ct==null?0:ct)/100);
	}

	public String getS_in_tmp_str() {
		return nf.format(Double.valueOf(s_in_tmp==null?0:s_in_tmp)/100);
	}

	public String getS_out_tmp_str() {
		return nf.format(Double.valueOf(s_out_tmp==null?0:s_out_tmp)/100);
	}

	public String getDt_tmp_str() {
		return nf.format(Double.valueOf(dt_tmp==null?0:dt_tmp)/100);
	}

	public String getCt_tmp_str() {
		return nf.format(Double.valueOf(ct_tmp==null?0:ct_tmp)/100);
	}
