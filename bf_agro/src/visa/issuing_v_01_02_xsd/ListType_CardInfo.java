...
public class ListType_CardInfo  implements java.io.Serializable {
    private visa.issuing_v_01_02_xsd.RowType_CardInfo[] row;

    public ListType_CardInfo() {
    }

    public ListType_CardInfo(
           visa.issuing_v_01_02_xsd.RowType_CardInfo[] row) {
           this.row = row;
    }
     ...
     * @return row
     */
    public visa.issuing_v_01_02_xsd.RowType_CardInfo[] getRow() {
        return row;
    }
     ...
     * @param row
     */
    public void setRow(visa.issuing_v_01_02_xsd.RowType_CardInfo[] row) {
        this.row = row;
    }

    public visa.issuing_v_01_02_xsd.RowType_CardInfo getRow(int i) {
        return this.row[i];
    }

    public void setRow(int i, visa.issuing_v_01_02_xsd.RowType_CardInfo _value) {
        this.row[i] = _value;
    }
