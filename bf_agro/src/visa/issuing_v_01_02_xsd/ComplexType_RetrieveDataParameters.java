...
public class ComplexType_RetrieveDataParameters  implements java.io.Serializable {
    ...
    private visa.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition;
    ...
    public ComplexType_RetrieveDataParameters(
           ...
           visa.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
     ...
     */
    public visa.issuing_v_01_02_xsd.RowType_FilterCondition[] getFilterCondition() {
        return filterCondition;
    }
     ...
     */
    public void setFilterCondition(visa.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
        this.filterCondition = filterCondition;
    }

    public visa.issuing_v_01_02_xsd.RowType_FilterCondition getFilterCondition(int i) {
        return this.filterCondition[i];
    }

    public void setFilterCondition(int i, visa.issuing_v_01_02_xsd.RowType_FilterCondition _value) {
