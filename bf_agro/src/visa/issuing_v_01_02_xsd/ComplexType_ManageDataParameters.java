...
public class ComplexType_ManageDataParameters  implements java.io.Serializable {
    ...
    private visa.issuing_v_01_02_xsd.ListType_ManageDataRows[] row;
    ...
    public ComplexType_ManageDataParameters(
           ...
           visa.issuing_v_01_02_xsd.ListType_ManageDataRows[] row) {
           this.target = target;
     ...
     * @return row
     */
    public visa.issuing_v_01_02_xsd.ListType_ManageDataRows[] getRow() {
        return row;
    }
     ...
     * @param row
     */
    public void setRow(visa.issuing_v_01_02_xsd.ListType_ManageDataRows[] row) {
        this.row = row;
    }

    public visa.issuing_v_01_02_xsd.ListType_ManageDataRows getRow(int i) {
        return this.row[i];
    }

    public void setRow(int i, visa.issuing_v_01_02_xsd.ListType_ManageDataRows _value) {
        this.row[i] = _value;
    }
