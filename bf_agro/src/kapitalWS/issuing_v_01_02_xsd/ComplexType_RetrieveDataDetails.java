...
public class ComplexType_RetrieveDataDetails  implements java.io.Serializable {
    private kapitalWS.issuing_v_01_02_xsd.ListType_Generic data;

    public ComplexType_RetrieveDataDetails() {
    }

    public ComplexType_RetrieveDataDetails(
           kapitalWS.issuing_v_01_02_xsd.ListType_Generic data) {
           this.data = data;
    }
     ...
     * @return data
     */
    public kapitalWS.issuing_v_01_02_xsd.ListType_Generic getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(kapitalWS.issuing_v_01_02_xsd.ListType_Generic data) {
        this.data = data;
    }
