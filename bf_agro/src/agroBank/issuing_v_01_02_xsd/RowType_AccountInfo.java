...
public class RowType_AccountInfo  implements java.io.Serializable {
    private agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Base base_info;

    private agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Additional additional_info;

    public RowType_AccountInfo() {
    }

    public RowType_AccountInfo(
           agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Base base_info,
           agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Additional additional_info) {
     ...
     * @return base_info
     */
    public agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Base getBase_info() {
        return base_info;
    }
     ...
     * @param base_info
     */
    public void setBase_info(agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Base base_info) {
        this.base_info = base_info;
    }
     ...
     */
    public agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Additional getAdditional_info() {
        return additional_info;
    }
     ...
     */
    public void setAdditional_info(agroBank.issuing_v_01_02_xsd.RowType_AccountInfo_Additional additional_info) {
        this.additional_info = additional_info;
    }
