...
public class IssuingPortProxy implements globus.IssuingWS.IssuingPort {
  ...
  private String _passwd = null;
	...
	private static String _remote_un;
	private static String _remote_pw;
...
//		    try {
		        ...
		        //prop.load(new FileInputStream("sets.properties"));
//		    	InputStream inputStream = 
//		    	    getClass().getClassLoader().getResourceAsStream("sets.properties");
//		    	prop.load(inputStream );
//
//		    	_remote_un = prop.getProperty("username");
//		    	_remote_pw = prop.getProperty("password");
...
//		if(_remote_un.equals(_username)){
//			new Exception("Bad Username"); 
//		}
//		if(_remote_un.equals(_username)){
//			new Exception("Bad Password"); 
//		}


	  System.out.println("_endpoint="+_endpoint);
	  _endpoint = endpoint;
	    _username = username;
	    _passwd = passwd;
	    _initIssuingPortProxy();
  ...
  public globus.issuing_v_01_02_xsd.OperationResponseInfo newCard(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.holders.RowType_AgreementHolder agreementInfo, globus.issuing_v_01_02_xsd.holders.ListType_AccountInfoHolder accountsListInfo, globus.issuing_v_01_02_xsd.holders.ListType_CardInfoHolder cardsListInfo) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    return issuingPort.newCard(connectionInfo, agreementInfo, accountsListInfo, cardsListInfo);
  }
  ...
  public globus.issuing_v_01_02_xsd.OperationResponseInfo replaceTokenCard(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_ReplaceTokenCard_Request parameters) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    return issuingPort.replaceTokenCard(connectionInfo, parameters);
  }
  ...
  public globus.issuing_v_01_02_xsd.OperationResponseInfo changeTokenStatus(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_ChangeTokenStatus_Request parameters) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    return issuingPort.changeTokenStatus(connectionInfo, parameters);
  }
  ...
  public void manageApplication4Installment(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_ManageApplication4Installment_Request parameters, globus.issuing_v_01_02_xsd.holders.OperationResponseInfoHolder responseInfo, globus.issuing_v_01_02_xsd.holders.RowType_ManageApplication4Installment_ResponseHolder details) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    issuingPort.manageApplication4Installment(connectionInfo, parameters, responseInfo, details);
  }
  ...
  public void getSuitableTransactionsForInstallments(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_GetSuitableTransactionsForInstallments_Request parameters, globus.issuing_v_01_02_xsd.holders.OperationResponseInfoHolder responseInfo, globus.issuing_v_01_02_xsd.holders.ListType_GenericHolder details) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    issuingPort.getSuitableTransactionsForInstallments(connectionInfo, parameters, responseInfo, details);
  }
  ...
  public void getInstallmentConditionsForTransaction(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_GetInstallmentConditionsForTransaction_Request parameters, globus.issuing_v_01_02_xsd.holders.OperationResponseInfoHolder responseInfo, globus.issuing_v_01_02_xsd.holders.ListType_GenericHolder details) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    issuingPort.getInstallmentConditionsForTransaction(connectionInfo, parameters, responseInfo, details);
  }
  ...
  public void createInstallmentAgreement(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_CreateInstallmentAgreement_Request parameters, globus.issuing_v_01_02_xsd.holders.OperationResponseInfoHolder responseInfo, globus.issuing_v_01_02_xsd.holders.RowType_CreateInstallmentAgreement_ResponseHolder details) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    issuingPort.createInstallmentAgreement(connectionInfo, parameters, responseInfo, details);
  }
  ...
  public globus.issuing_v_01_02_xsd.OperationResponseInfo closeInstallmentAgreement(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_CloseInstallmentAgreement_Request parameters) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    return issuingPort.closeInstallmentAgreement(connectionInfo, parameters);
  }
  ...
  public void calculateInstallmentPlanNew(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_CalculateInstallmentPlanNew_Request parameters, globus.issuing_v_01_02_xsd.holders.OperationResponseInfoHolder responseInfo, globus.issuing_v_01_02_xsd.holders.RowType_CalculateInstallmentPlanNew_ResponseHolder details) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    issuingPort.calculateInstallmentPlanNew(connectionInfo, parameters, responseInfo, details);
  }
  ...
  public void getInstallmentConditionsForRequest(globus.issuing_v_01_02_xsd.OperationConnectionInfo connectionInfo, globus.issuing_v_01_02_xsd.RowType_GetInstallmentConditionsForRequest_Request parameters, globus.issuing_v_01_02_xsd.holders.OperationResponseInfoHolder responseInfo, globus.issuing_v_01_02_xsd.holders.ListType_GenericHolder details) throws java.rmi.RemoteException{
    if (issuingPort == null)
      _initIssuingPortProxy();
    issuingPort.getInstallmentConditionsForRequest(connectionInfo, parameters, responseInfo, details);
  }

@Override
public String toString() {
	return "IssuingPortProxy [_endpoint=" + _endpoint + ", issuingPort="
			+ issuingPort + ", _username=" + _username + ", _passwd=" + _passwd
			+ "]";
}
