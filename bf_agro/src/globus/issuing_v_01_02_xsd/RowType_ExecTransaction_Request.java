...
public class RowType_ExecTransaction_Request  implements java.io.Serializable {
	...
	public String toString() {
		return "RowType_ExecTransaction_Request [PAYMENT_MODE=" + PAYMENT_MODE
				+ ", ACCOUNT_NO=" + ACCOUNT_NO + ", CARD_ACCT=" + CARD_ACCT
				+ ", CARD_ACCT_CCY=" + CARD_ACCT_CCY + ", CARD=" + CARD
				+ ", EXECUTE_ON=" + EXECUTE_ON + ", TRAN_TYPE=" + TRAN_TYPE
				+ ", TRAN_CCY=" + TRAN_CCY + ", TRAN_AMNT=" + TRAN_AMNT
				+ ", BRANCH=" + BRANCH + ", BATCH_NR=" + BATCH_NR
				+ ", SLIP_NR=" + SLIP_NR + ", DEAL_DESC=" + DEAL_DESC
				+ ", COUNTERPARTY=" + COUNTERPARTY + ", INTERNAL_NO="
				+ INTERNAL_NO + ", BANK_C=" + BANK_C + ", GROUPC=" + GROUPC
				+ ", TRAN_DATE_TIME=" + TRAN_DATE_TIME + ", EXECUTION_TYPE="
				+ EXECUTION_TYPE + ", BOOKING_MSG=" + BOOKING_MSG
				+ ", TR_CODE=" + TR_CODE + ", TR_FEE=" + TR_FEE + ", TR_CODE2="
				+ TR_CODE2 + ", TR_FEE2=" + TR_FEE2 + ", TR_CODE3=" + TR_CODE3
				+ ", TR_FEE3=" + TR_FEE3 + ", TR_CODE4=" + TR_CODE4
				+ ", TR_FEE4=" + TR_FEE4 + ", TR_CODE5=" + TR_CODE5
				+ ", TR_FEE5=" + TR_FEE5 + ", TR_CODE6=" + TR_CODE6
				+ ", TR_FEE6=" + TR_FEE6 + ", TR_CODE7=" + TR_CODE7
				+ ", TR_FEE7=" + TR_FEE7 + ", TR_CODE8=" + TR_CODE8
				+ ", TR_FEE8=" + TR_FEE8 + ", TR_CODE9=" + TR_CODE9
				+ ", TR_FEE9=" + TR_FEE9 + ", TR_CODE10=" + TR_CODE10
				+ ", TR_FEE10=" + TR_FEE10 + ", CHECK_DUPL=" + CHECK_DUPL
				+ ", INSTL_AGR_NO=" + INSTL_AGR_NO + ", ACCNT_TYPE="
				+ ACCNT_TYPE + ", __equalsCalc=" + __equalsCalc
