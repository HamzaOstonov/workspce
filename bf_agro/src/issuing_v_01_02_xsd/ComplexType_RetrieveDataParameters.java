...
public class ComplexType_RetrieveDataParameters  implements java.io.Serializable {
    ...
    private issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition;
    ...
    public ComplexType_RetrieveDataParameters(
           ...
           issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
     ...
     */
    public issuing_v_01_02_xsd.RowType_FilterCondition[] getFilterCondition() {
        return filterCondition;
    }
     ...
     */
    public void setFilterCondition(issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
        this.filterCondition = filterCondition;
    }

    public issuing_v_01_02_xsd.RowType_FilterCondition getFilterCondition(int i) {
        return this.filterCondition[i];
    }

    public void setFilterCondition(int i, issuing_v_01_02_xsd.RowType_FilterCondition _value) {
