...
public class ComplexType_RetrieveDataParameters  implements java.io.Serializable {
    ...
    private capitalBank.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition;
    ...
    public ComplexType_RetrieveDataParameters(
           ...
           capitalBank.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
     ...
     */
    public capitalBank.issuing_v_01_02_xsd.RowType_FilterCondition[] getFilterCondition() {
        return filterCondition;
    }
     ...
     */
    public void setFilterCondition(capitalBank.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
        this.filterCondition = filterCondition;
    }

    public capitalBank.issuing_v_01_02_xsd.RowType_FilterCondition getFilterCondition(int i) {
        return this.filterCondition[i];
    }

    public void setFilterCondition(int i, capitalBank.issuing_v_01_02_xsd.RowType_FilterCondition _value) {
