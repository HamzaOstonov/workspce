...
public final class ListType_AccountInfoHolder implements javax.xml.rpc.holders.Holder {
    public capitalBank.issuing_v_01_02_xsd.ListType_AccountInfo value;

    public ListType_AccountInfoHolder() {
    }

    public ListType_AccountInfoHolder(capitalBank.issuing_v_01_02_xsd.ListType_AccountInfo value) {
        this.value = value;
    }
