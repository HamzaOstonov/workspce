...
public class ComplexType_RetrieveDataDetails  implements java.io.Serializable {
    private capitalBank.issuing_v_01_02_xsd.ListType_Generic data;

    public ComplexType_RetrieveDataDetails() {
    }

    public ComplexType_RetrieveDataDetails(
           capitalBank.issuing_v_01_02_xsd.ListType_Generic data) {
           this.data = data;
    }
     ...
     * @return data
     */
    public capitalBank.issuing_v_01_02_xsd.ListType_Generic getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(capitalBank.issuing_v_01_02_xsd.ListType_Generic data) {
        this.data = data;
    }
