...
public class ComplexType_ManageDataParameters  implements java.io.Serializable {
    ...
    private capitalBank.issuing_v_01_02_xsd.ListType_ManageDataRows[] row;
    ...
    public ComplexType_ManageDataParameters(
           ...
           capitalBank.issuing_v_01_02_xsd.ListType_ManageDataRows[] row) {
           this.target = target;
     ...
     * @return row
     */
    public capitalBank.issuing_v_01_02_xsd.ListType_ManageDataRows[] getRow() {
        return row;
    }
     ...
     * @param row
     */
    public void setRow(capitalBank.issuing_v_01_02_xsd.ListType_ManageDataRows[] row) {
        this.row = row;
    }

    public capitalBank.issuing_v_01_02_xsd.ListType_ManageDataRows getRow(int i) {
        return this.row[i];
    }

    public void setRow(int i, capitalBank.issuing_v_01_02_xsd.ListType_ManageDataRows _value) {
        this.row[i] = _value;
    }
