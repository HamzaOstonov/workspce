...
public class ComplexType_RetrieveDataParameters  implements java.io.Serializable {
    ...
    private globus.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition;
    ...
    public ComplexType_RetrieveDataParameters(
           ...
           globus.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
     ...
     */
    public globus.issuing_v_01_02_xsd.RowType_FilterCondition[] getFilterCondition() {
        return filterCondition;
    }
     ...
     */
    public void setFilterCondition(globus.issuing_v_01_02_xsd.RowType_FilterCondition[] filterCondition) {
        this.filterCondition = filterCondition;
    }

    public globus.issuing_v_01_02_xsd.RowType_FilterCondition getFilterCondition(int i) {
        return this.filterCondition[i];
    }

    public void setFilterCondition(int i, globus.issuing_v_01_02_xsd.RowType_FilterCondition _value) {
