...
public class RowType_CardInfo  implements java.io.Serializable {
    private visa.issuing_v_01_02_xsd.RowType_CardInfo_LogicalCard logicalCard;

    private visa.issuing_v_01_02_xsd.RowType_CardInfo_PhysicalCard physicalCard;

    private visa.issuing_v_01_02_xsd.RowType_CardInfo_EMV_Data EMV_Data;

    private visa.issuing_v_01_02_xsd.ListType_AddServInfo addServInfo;

    private visa.issuing_v_01_02_xsd.RowType_CardInfo_TSM_Data TSM_Data;

    public RowType_CardInfo() {
    }

    public RowType_CardInfo(
           visa.issuing_v_01_02_xsd.RowType_CardInfo_LogicalCard logicalCard,
           visa.issuing_v_01_02_xsd.RowType_CardInfo_PhysicalCard physicalCard,
           visa.issuing_v_01_02_xsd.RowType_CardInfo_EMV_Data EMV_Data,
           visa.issuing_v_01_02_xsd.ListType_AddServInfo addServInfo,
           visa.issuing_v_01_02_xsd.RowType_CardInfo_TSM_Data TSM_Data) {
     ...
     * @return logicalCard
     */
    public visa.issuing_v_01_02_xsd.RowType_CardInfo_LogicalCard getLogicalCard() {
        return logicalCard;
    }
     ...
     * @param logicalCard
     */
    public void setLogicalCard(visa.issuing_v_01_02_xsd.RowType_CardInfo_LogicalCard logicalCard) {
        this.logicalCard = logicalCard;
    }
     ...
     * @return physicalCard
     */
    public visa.issuing_v_01_02_xsd.RowType_CardInfo_PhysicalCard getPhysicalCard() {
        return physicalCard;
    }
     ...
     * @param physicalCard
     */
    public void setPhysicalCard(visa.issuing_v_01_02_xsd.RowType_CardInfo_PhysicalCard physicalCard) {
        this.physicalCard = physicalCard;
    }
     ...
     * @return EMV_Data
     */
    public visa.issuing_v_01_02_xsd.RowType_CardInfo_EMV_Data getEMV_Data() {
        return EMV_Data;
    }
     ...
     * @param EMV_Data
     */
    public void setEMV_Data(visa.issuing_v_01_02_xsd.RowType_CardInfo_EMV_Data EMV_Data) {
        this.EMV_Data = EMV_Data;
    }
     ...
     * @return addServInfo
     */
    public visa.issuing_v_01_02_xsd.ListType_AddServInfo getAddServInfo() {
        return addServInfo;
    }
     ...
     * @param addServInfo
     */
    public void setAddServInfo(visa.issuing_v_01_02_xsd.ListType_AddServInfo addServInfo) {
        this.addServInfo = addServInfo;
    }
     ...
     * @return TSM_Data
     */
    public visa.issuing_v_01_02_xsd.RowType_CardInfo_TSM_Data getTSM_Data() {
        return TSM_Data;
    }
     ...
     * @param TSM_Data
     */
    public void setTSM_Data(visa.issuing_v_01_02_xsd.RowType_CardInfo_TSM_Data TSM_Data) {
        this.TSM_Data = TSM_Data;
    }
