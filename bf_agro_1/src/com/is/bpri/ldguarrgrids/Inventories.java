...
public class Inventories extends GenericForwardComposer{
	
	private Div inventoriesdiv,grd;
	private Textbox id_client,name,address,doc_num,notarial_doc_numb,inn_reestr,name2,insc_inn,insc_num,polis_num;
	private RefCBox currency,klass_o,code_subject,niki_res1,acomp_name,acomp_curr;
	private Datebox doc_date,start_date,insc_date,insc_date_cl,acomp_date,polis_date,date_operation;
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		refCboxsetModels();
		inputDatas();
		inventoriesdiv.setVisible(true);
	...
	private void inputDatas(){
		if(clickbtn.equals("double")){
			...
			Utils.clearForm(inventoriesdiv);
			inventoriesdiv.setVisible(false);
		}
