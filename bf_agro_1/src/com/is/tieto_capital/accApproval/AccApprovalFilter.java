...
public class AccApprovalFilter implements Serializable {
	...
	public AccApprovalFilter() {
		super();
	}

	public AccApprovalFilter(Long id, String account, String branch, Long state_id, String fullname, Date birthday,
			String passport_serial, String passport_number, String bank_id, String tieto_id, String deal_group_id,
			String deal_id, String action_id) {
		super();
		this.id = id;
