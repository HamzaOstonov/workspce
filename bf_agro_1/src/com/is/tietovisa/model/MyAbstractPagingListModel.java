...
public abstract class MyAbstractPagingListModel<T> extends AbstractListModel {
    ...
    public MyAbstractPagingListModel(int startPageNumber, int pageSize) {
        super();
    ...
    public MyAbstractPagingListModel(int startPageNumber, int pageSize, Object fl, String alias) {
            super();
