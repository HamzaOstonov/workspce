...
public class UFXMsgReqContractResp {
	 ...
	 private MsgDataReqContract MsgDataObject;
	 ...
	 @JsonProperty("MsgData")
	 public MsgDataReqContract getMsgDataReq() {
	...
	public String getResp_text() {
	 ...
	 @JsonProperty("MsgData")
	 public void setMsgDataReq(MsgDataReqContract MsgDataObject) {
