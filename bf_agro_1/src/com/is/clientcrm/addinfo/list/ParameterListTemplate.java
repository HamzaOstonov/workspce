...
public class ParameterListTemplate implements Serializable {
	...
	private String param_width_t;
	private String param_actions;
	private int param_act_runatstart;

    public ParameterListTemplate() {
		super();
    }

	public ParameterListTemplate(String client_type, String param_id, String param_list_teg, String param_select, String param_type, String param_mask, String param_def_value, Long param_ord, int param_mandatory, int param_align, String param_constraints, String param_enable, String param_visible, int param_visible_t, String param_width_t, String param_actions, int param_act_runatstart) {
		super();
		...
		this.param_width_t = param_width_t;
	...
	public String getParam_width_t() {
		return param_width_t;
	}

	public void setParam_width_t(String param_width_t) {
		this.param_width_t = param_width_t;
	}
