...
public class AccountFilter {
    ...
    private int state;
    private String id_order_not;
    
    public AccountFilter() {
    	super();
    }

	public AccountFilter(String branch, String id, String acc_bal, String currency,
	...
	public void setId_order_not(String id_order_not) {
		this.id_order_not = id_order_not;
	}

	public String getId_order_not() {
		return id_order_not;
	}
