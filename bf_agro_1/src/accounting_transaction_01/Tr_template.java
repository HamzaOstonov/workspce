...
public class Tr_template
{
	...
	public Tr_template(long id, long operation_id, long acc_dt, long acc_ct,
			...
			String purpose_code, long ord, long id_transh_purp, long pay_type,
	...
	{
		return "Tr_template [id=" + id + ", operation_id=" + operation_id
				+ ", acc_dt=" + acc_dt + ", acc_ct=" + acc_ct + ", currency="
				+ currency + ", doc_type=" + doc_type + ", cash_code="
				+ cash_code + ", purpose=" + purpose + ", purpose_code="
				+ purpose_code + ", ord=" + ord + ", id_transh_purp="
				+ id_transh_purp + ", pay_type=" + pay_type + ", trans_type="
				+ trans_type + ", perc_for_tr=" + perc_for_tr + ", pdc=" + pdc
				+ ", amount=" + amount + "]";
	}
