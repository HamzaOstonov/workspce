...
public class ComplexType_RetrieveDataDetails  implements java.io.Serializable {
    private globus.issuing_v_01_02_xsd.ListType_Generic data;

    public ComplexType_RetrieveDataDetails() {
    }

    public ComplexType_RetrieveDataDetails(
           globus.issuing_v_01_02_xsd.ListType_Generic data) {
           this.data = data;
    }
     ...
     * @return data
     */
    public globus.issuing_v_01_02_xsd.ListType_Generic getData() {
        return data;
    }
     ...
     * @param data
     */
    public void setData(globus.issuing_v_01_02_xsd.ListType_Generic data) {
        this.data = data;
    }
