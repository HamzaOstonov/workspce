...
public class RowType_LimitEvent  implements java.io.Serializable {
    ...
    private globus.issuing_v_01_02_xsd.RowType_LimitEvent_Limit[] limit;
    ...
    public RowType_LimitEvent(
           ...
           globus.issuing_v_01_02_xsd.RowType_LimitEvent_Limit[] limit) {
     ...
     * @return limit
     */
    public globus.issuing_v_01_02_xsd.RowType_LimitEvent_Limit[] getLimit() {
        return limit;
    }
     ...
     * @param limit
     */
    public void setLimit(globus.issuing_v_01_02_xsd.RowType_LimitEvent_Limit[] limit) {
        this.limit = limit;
    }

    public globus.issuing_v_01_02_xsd.RowType_LimitEvent_Limit getLimit(int i) {
        return this.limit[i];
    }

    public void setLimit(int i, globus.issuing_v_01_02_xsd.RowType_LimitEvent_Limit _value) {
        this.limit[i] = _value;
    }
