...
public class ListType_ManageDataRows  implements java.io.Serializable {
    private globus.issuing_v_01_02_xsd.RowType_ManageDataCol[] col;

    public ListType_ManageDataRows() {
    }

    public ListType_ManageDataRows(
           globus.issuing_v_01_02_xsd.RowType_ManageDataCol[] col) {
           this.col = col;
    }
     ...
     * @return col
     */
    public globus.issuing_v_01_02_xsd.RowType_ManageDataCol[] getCol() {
        return col;
    }
     ...
     * @param col
     */
    public void setCol(globus.issuing_v_01_02_xsd.RowType_ManageDataCol[] col) {
        this.col = col;
    }

    public globus.issuing_v_01_02_xsd.RowType_ManageDataCol getCol(int i) {
        return this.col[i];
    }

    public void setCol(int i, globus.issuing_v_01_02_xsd.RowType_ManageDataCol _value) {
        this.col[i] = _value;
    }
