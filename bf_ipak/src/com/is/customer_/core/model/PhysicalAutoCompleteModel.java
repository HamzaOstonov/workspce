...
public class PhysicalAutoCompleteModel {
	...
	public PhysicalAutoCompleteModel() {
		
	}

	public PhysicalAutoCompleteModel(String subject_state, String inn,
			String inn_registrated, String inn_registrated_gni, String pin,
			String last_name, String first_name, String patronym,
			String surname, String givenname, Date birth_date, Integer sex,
			String passport_seria, String passport_number, Date date_issue,
			Date date_expiry, String give_place, String give_place_name,
			String birth_country, String birth_country_name,
			String birth_place, String nationality, String nationality_desc,
			String citizenship, String citizenship_name,
			String domicile_country, String domicile_region,
			String domicile_district, String domicile_place_desc,
			String domicile_street_desc, String domicile_address,
			String domicile_house, String domicile_block, String domicile_flat,
			String domicile_begin, String temp_country, String temp_region,
			String temp_district, String temp_place_desc, String temp_address,
			String temp_house, String temp_block, String temp_flat,
			String temp_begin, String temp_end) {
		super();
