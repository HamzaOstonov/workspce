...
public class TheService {
	...
	public static FizInfoDetailsResponse fizInfoDetailsResponse(String branch, String pinfl, String passp_ser, String passp_num) throws Exception {
		...
		//String contentTemp = "{     \"Result\": 1,     \"Data\": {\"personaldata\": {\"row\":    {        \"queryld\": \"string\",        \"pinpp\": \"31312781080071\",        \"document\": \"AB2429121\",        \"surnamelatin\": \"OSTONOV\",        \"namelatin\": \"HAMZA\",        \"patronymlatin\": \"GëOFURJONOVICH\",        \"engsurname\": \"OSTONOV\",        \"engname\": \"KHAMZA\",        \"birth_date\": \"1978-12-13\",        \"birthplace\": \"QORAKOëL TUMANI\",        \"birthplaceid\": \"\",        \"birthcountry\": \"”«¡≈ »—“¿Õ\",        \"birthcountryid\": 860,        \"livestatus\": 1,        \"nationality\": \"”«¡≈ /”«¡≈◊ ¿\",        \"nationalityid\": \"01\",        \"citizenship\": \"”«¡≈ »—“¿Õ\",        \"citizenshipid\": 860,        \"sex\": 1,        \"docgiveplace\": \"¡”’¿–— »… √Œ¬ƒ ¡”’¿–— Œ… Œ¡À¿—“»\",        \"docgiveplaceid\": 6206,        \"docdatebegin\": \"2016-01-11\",        \"docdateend\": \"2026-01-10\"     }}}  }";
	...
	public static FizAddressResponse fizAddressResponse(String branch, String pinfl) throws Exception {
        ...
        "};";
		String content = sendData(url, p_data);
		//String contentTemp = "{   \"Data\":    {      \"PermanentRegistration\":       {         \"Cadastre\": \"10:07:02:01:02:5011:0001:030\",         \"Country\":          {            \"Id\": \"860\",            \"Value\": \"°«¡≈ »—“ŒÕ\",            \"IdValue\": \"(182) °«¡≈ »—“ŒÕ\"         },         \"Region\":          {            \"Id\": \"26\",            \"Value\": \"“Œÿ ≈Õ“ ÿ¿’–»\",            \"IdValue\": \"(10) “Œÿ ≈Õ“ ÿ¿’–»\"         },         \"District\":          {            \"Id\": \"200\",            \"Value\": \"ﬁÕ”—Œ¡Œƒ “”Ã¿Õ»\",            \"IdValue\": \"(1010) ﬁÕ”—Œ¡Œƒ “”Ã¿Õ»\"         },         \"Address\": \"„. “‡¯ÍÂÌÚ, ﬁÌÛÒ‡·‡‰ÒÍËÈ ‡ÈÓÌ, ÛÎ. ◊ËÌ„ËÁ ¿ÈÚÏ‡ÚÓ‚, ﬂÌ„ËÚ‡ÌÓ‚ Ã—√, 1- ƒÓÏ, 30-  ‚‡ÚË‡\",         \"RegistrationDate\": \"2021-06-11T00:00:00\"      },      \"TemproaryRegistrations\": []   },   \"AnswereId\": 1,   \"AnswereMessage\": \"Ok\",   \"AnswereComment\": \"\"}";
		if (!content.equals(""))
			try {
	...
	public static FizPhotoResponse fizPhotoResponse(String branch, String pinfl, String docdate) throws Exception {
		...
		strB.append("\"sex\": 1,");
		strB.append("\"docgiveplace\": \"¡”’¿–— »… √Œ¬ƒ ¡”’¿–— Œ… Œ¡À¿—“»\",");
	...
	public static FizDocsResponse fizDocsResponse(String branch, FizDocsRequest query) throws Exception {
		...
		strB.append("      \"patronymlat\": \"GëOFURJONOVICH\",                                  ");
		strB.append("      \"surnamecyr\": \"Œ—“ŒÕŒ¬\",                                          ");
		strB.append("      \"namecyr\": \"?¿Ã«¿\",                                               ");
		strB.append("      \"patronymcyr\": \"?Œ‘”–∆ŒÕŒ¬»◊\",                                    ");
		strB.append("      \"engsurname\": \"OSTONOV\",                                          ");
		strB.append("      \"engname\": \"KHAMZA\",                                              ");
		...
		*/
		...
		strB.append("            \"docgiveplace\": \"Œ“ƒ≈À «¿√— π 2 √Œ–Œƒ¿ ¡”’¿–¿\",                    ");
		...
		strB.append("         }                                                                         ");
		strB.append("      ],                                                                           ");
		strB.append("      \"surnamelat\": \"GëAFURJONOV\",                                             ");
		strB.append("      \"namelat\": \"FIRDAVS\",                                                    ");
		strB.append("      \"patronymlat\": \"HAMZA-OëGëLI\",                                           ");
		strB.append("      \"surnamecyr\": \"?¿‘”–∆ŒÕŒ¬\",                                              ");
		strB.append("      \"namecyr\": \"‘»–ƒ¿¬—\",                                                    ");
		strB.append("      \"patronymcyr\": \"?¿Ã«¿-°?À»\",                                             ");
