...
public class Response {
    ...
    public Response(int count, String branch, String nciId, String sapId, String lastNameGlobal, String firstNameGlobal, String middleNameGlobal, String lastNameLocal, String firstNameLocal, String middleNameLocal, Date birthDay) {
        this.count = count;
        this.branch = branch;
        this.nciId = nciId;
        this.sapId = sapId;
    ...
    public String toString() {
        return "Response{" +
                ...
                ", nciId='" + nciId + '\'' +
                ", sapId='" + sapId + '\'' +
                ", lastNameGlobal='" + lastNameGlobal + '\'' +
                ", firstNameGlobal='" + firstNameGlobal + '\'' +
                ", middleNameGlobal='" + middleNameGlobal + '\'' +
