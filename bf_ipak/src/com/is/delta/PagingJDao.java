...
public class PagingJDao implements PagingDao<DELTARecord> {
    ...
    private final String BODY =
            "select rownum rownm, t.*\n" +
                    ...
                    "                   and s.id_client = a.client_id) name\n" +
                    "          from delta_cl_load_requests a\n" +
                    "         where a.customer_type in ('02', '06') and (a.state_id = 3 or a.state_id = 4)\n" +
                    "        union all\n" +
                    "        select h.branch,\n" +
                    "               h.id,\n" +
                    "               '02',\n" +
    ...
    public PagingJDao(SessionAttributes sessionAttributes) {
        this.sessionAttributes = sessionAttributes;
    }

    public static PagingJDao getInstance(SessionAttributes sessionAttributes) {
        return new PagingJDao(sessionAttributes);
    }
    ...
    private DELTARecord mapResultSet(ResultSet rs) throws SQLException {
        ...
        // DELTARecord.setDate(rs.getDate("date"));
        return DELTARecord;
    }
