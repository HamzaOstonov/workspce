...
public class ClientJFilter extends ClientJ implements Serializable {

    static final long serialVersionUID = 3L;

    private String clientIds;

    public ClientJFilter() {
        super();
    }

    public ClientJFilter(String id_client, String state) {

        this.id_client = id_client;
        this.state = state;
    }

    private ClientJFilter(String clientIds) {
        this.clientIds = clientIds;
    }

    public static ClientJFilter clientIds(String clientIds) {
        return new ClientJFilter(clientIds);
    }
