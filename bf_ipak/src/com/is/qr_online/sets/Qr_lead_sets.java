...
public class Qr_lead_sets {
	...
	public Qr_lead_sets(String payee_id,String id,String branch_dt, String account_dt, String branch_ct, String account_ct,
	...
	public Qr_lead_sets(String payee_id,String branch_dt, String account_dt, String branch_ct, String account_ct,
			String inn_ct, String purpose_code, String purpose) {
		super();
		this.payee_id = payee_id;
		this.branch_dt = branch_dt;
	...
	public String toString() {
		return "Qr_lead_sets [id=" + id + ", branch_dt=" + branch_dt + ", account_dt=" + account_dt  + ", branch_ct=" + branch_ct + ", account_ct=" + account_ct + ", inn_ct=" + inn_ct
				+ ", purpose_code=" + purpose_code + ", purpose=" + purpose + "]";
	}
