...
public class General implements Serializable {
    ...
    public General(Long id, String branch, String doc_num, Date d_date, String bank_cl, String acc_cl, String name_cl, String bank_co, String acc_co, String name_co, String purpose, BigDecimal summa, String currency, String type_doc, Long s_deal_id, Date v_date, String pdc, String cash_code, Long state, Long parent_group_id, Long parent_id, Long child_id, Long kod_err, String file_name, Long err_general, Long emp_id, Long id_transh, Long id_transh_purp, Date val_date, String state_desc) {
		super();
		this.id = id;
		this.branch = branch;
