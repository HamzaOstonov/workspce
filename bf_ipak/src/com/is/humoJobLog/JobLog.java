...
public class JobLog
{
    ...
    public JobLog(final long id, final String branch, final String type) {
        this.id = id;
        this.branch = branch;
    ...
    public JobLog(final long id, final String branch, final String id_client, final String name,
	...
	public JobLog clone (JobLog old) {
		JobLog newCust=new JobLog();
	...
	public void copyTietoFields (JobLog old, JobLog newCust) {
    ...
    public boolean hasBankChanges(JobLog old) {
