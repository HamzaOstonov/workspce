...
public class CreditApp {
	...
	public CreditApp(Long id, String branch, String id_client, String reqnum,
			String reqtype, String branch_id, String kred_id, String shifr_id,
			String currency, String amount, Date end_date, String dbinn,
			...
			String etype, String type_zm, String bank_inps,String code,String state,String state_name,
			Date rdate,String ragency,String rreason,String rtxt,String rdoc) {
		super();
		this.id = id;
		this.branch = branch;
	...
	public String getRagency() {
		return ragency;
	}

	public void setRagency(String ragency) {
		this.ragency = ragency;
	}
