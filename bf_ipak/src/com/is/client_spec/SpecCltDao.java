...
public class SpecCltDao implements Dao<SpecClt> {
	...
	@Override
	public List<SpecClt> getListWithPaging(int pageIndex, int pageSize) {
	...
	@Override
	public SpecClt getItemByLongId(String branch,long itemId) {
	...
	@Override
	public SpecClt getItemByStringId(String branch,String itemId) {
	...
	@Override
	public SpecClt getItemByLongId(Connection c,String branch, long itemId) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public SpecClt getItemByStringId(Connection c,String branch, String itemId) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<SpecClt> getList() {
		// TODO Auto-generated method stub
		return null;
	}
