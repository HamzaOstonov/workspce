...
import org.python.indexer.Outliner.Branch;
...
import IssuingWS.IssuingServiceLocator;
...
public class CustomerViewCtrl  extends GenericForwardComposer{
   ...
   // private Tabbox frmgrd;
    ...
    private Toolbar tb;
    private Textbox p_birth_place,id,branch,id_client,name,code_country,code_type,code_resident,code_subject,sign_registr,code_form,date_open,date_close,state,p_birthday,p_post_address,p_passport_serial,p_passport_number,p_passport_place_registration,p_passport_date_registration,p_number_tax_registration,p_capacity_status_date,p_capacity_status_place,p_num_certif_capacity,p_phone_home,p_phone_mobile,p_email_address,p_pension_sertif_serial,p_passport_date_expiration,p_inps,p_pinfl,p_family,p_first_name,p_patronymic;
    private Textbox ap_birth_place,aid,abranch,aid_client,aname,acode_subject,asign_registr,acode_form,astate,ap_post_address,ap_passport_serial,ap_passport_number,ap_passport_place_registration,ap_number_tax_registration,ap_capacity_status_date,ap_capacity_status_place,ap_num_certif_capacity,ap_phone_home,ap_phone_mobile,ap_email_address,ap_pension_sertif_serial,ap_inps,ap_pinfl,ap_family,ap_first_name,ap_patronymic ;
    private Textbox fid,fbranch,fid_client,fname,fcode_country,fcode_type,fcode_resident,fcode_subject,fsign_registr,fcode_form,fdate_open,fdate_close,fstate,fp_post_address,fp_passport_serial,fp_passport_number,fp_passport_place_registration,fp_passport_date_registration,fp_number_tax_registration,fp_birth_place,fp_capacity_status_date,fp_capacity_status_place,fp_num_certif_capacity,fp_phone_home,fp_phone_mobile,fp_email_address,fp_pension_sertif_serial,fp_passport_date_expiration,fp_inps,fp_pinfl,fp_family,fp_first_name,fp_patronymic ;
    ...
    private RefCBox acode_resident,acode_type,acode_country,ap_passport_type,ap_code_tax_org,ap_code_bank,ap_code_class_credit,ap_code_citizenship,ap_code_capacity,ap_code_gender,ap_code_nation,ap_code_birth_region,ap_code_birth_distr,ap_type_document,ap_code_adr_region,ap_code_adr_distr;
    private RefCBox fp_passport_type,fp_code_tax_org,fp_code_bank,fp_code_class_credit,fp_code_citizenship,fp_code_capacity,fp_code_gender,fp_code_nation,fp_code_birth_region,fp_code_birth_distr,fp_type_document,fp_code_adr_region,fp_code_adr_distr;
...
public void doAfterCompose(Component comp) throws Exception {
    ...
    LtLogger.getLogger().error("doaftercompose customerviewctrl 2021.08.31 001");
    ...
    public void render(Listitem row, Object data) throws Exception {
                ...
                /*
                row.appendChild(new Listcell(pCustomer.getId()+""));
                row.appendChild(new Listcell(pCustomer.getBranch()));
               */
                row.appendChild(new Listcell(pCustomer.getId_client()));
                row.appendChild(new Listcell(pCustomer.getName()));
                /*
                row.appendChild(new Listcell(pCustomer.getCode_country()));
                row.appendChild(new Listcell(pCustomer.getCode_type()));
                row.appendChild(new Listcell(pCustomer.getCode_resident()));
                row.appendChild(new Listcell(pCustomer.getCode_subject()));
                row.appendChild(new Listcell(pCustomer.getSign_registr()+""));
                row.appendChild(new Listcell(pCustomer.getCode_form()+""));
                row.appendChild(new Listcell(pCustomer.getDate_open()+""));
                row.appendChild(new Listcell(pCustomer.getDate_close()+""));
                row.appendChild(new Listcell(pCustomer.getState()+""));
                row.appendChild(new Listcell(pCustomer.getP_birthday()+""));
                */
                row.appendChild(new Listcell(pCustomer.getP_post_address()));
                /*
                row.appendChild(new Listcell(pCustomer.getP_passport_type()));
                row.appendChild(new Listcell(pCustomer.getP_passport_serial()));
                row.appendChild(new Listcell(pCustomer.getP_passport_number()));
                row.appendChild(new Listcell(pCustomer.getP_passport_place_registration()));
                row.appendChild(new Listcell(pCustomer.getP_passport_date_registration()+""));
                row.appendChild(new Listcell(pCustomer.getP_code_tax_org()));
                row.appendChild(new Listcell(pCustomer.getP_number_tax_registration()));
                row.appendChild(new Listcell(pCustomer.getP_code_bank()));
                row.appendChild(new Listcell(pCustomer.getP_code_class_credit()));
                row.appendChild(new Listcell(pCustomer.getP_code_citizenship()));
                row.appendChild(new Listcell(pCustomer.getP_birth_place()));
                row.appendChild(new Listcell(pCustomer.getP_code_capacity()));
                row.appendChild(new Listcell(pCustomer.getP_capacity_status_date()+""));
                row.appendChild(new Listcell(pCustomer.getP_capacity_status_place()));
                row.appendChild(new Listcell(pCustomer.getP_num_certif_capacity()));
                row.appendChild(new Listcell(pCustomer.getP_phone_home()));
                row.appendChild(new Listcell(pCustomer.getP_phone_mobile()));
                row.appendChild(new Listcell(pCustomer.getP_email_address()));
                row.appendChild(new Listcell(pCustomer.getP_pension_sertif_serial()));
                row.appendChild(new Listcell(pCustomer.getP_code_gender()));
                row.appendChild(new Listcell(pCustomer.getP_code_nation()));
                row.appendChild(new Listcell(pCustomer.getP_code_birth_region()));
                row.appendChild(new Listcell(pCustomer.getP_code_birth_distr()));
                row.appendChild(new Listcell(pCustomer.getP_type_document()));
                row.appendChild(new Listcell(pCustomer.getP_passport_date_expiration()+""));
                row.appendChild(new Listcell(pCustomer.getP_code_adr_region()));
                row.appendChild(new Listcell(pCustomer.getP_code_adr_distr()));
                row.appendChild(new Listcell(pCustomer.getP_inps()));
                row.appendChild(new Listcell(pCustomer.getP_family()));
                row.appendChild(new Listcell(pCustomer.getP_first_name()));
                row.appendChild(new Listcell(pCustomer.getP_patronymic()));
*/
       ...
       // p_passport_type.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_document())));
        p_code_tax_org.setModel((new ListModelList(com.is.utilsti.RefDataService.getTax(alias)))); 
        p_code_bank.setModel((new ListModelList(com.is.utilsti.RefDataService.getMfo(alias)))); 
        p_code_class_credit.setModel((new ListModelList(com.is.utilsti.RefDataService.getClassCR(alias)))); 
        p_code_citizenship.setModel((new ListModelList(com.is.utilsti.RefDataService.getCountry(alias)))); 
        //p_birth_place.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr()))); 
        //p_code_capacity.setModel((new ListModelList(com.is.utilsti.RefDataService.getCapacity()))); 
        p_code_gender.setModel((new ListModelList(com.is.utilsti.RefDataService.getGender(alias)))); 
        p_code_nation.setModel((new ListModelList(com.is.utilsti.RefDataService.getNation(alias)))); 
        p_code_birth_region.setModel((new ListModelList(com.is.utilsti.RefDataService.getRegion(alias)))); 
        p_code_birth_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(alias)))); 
        p_type_document.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_document(alias)))); 
        p_code_adr_region.setModel((new ListModelList(com.is.utilsti.RefDataService.getRegion(alias)))); 
        p_code_adr_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(alias)))); 
        
        ap_type_document.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_document(alias))));
        //ap_passport_type.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_document())));
        ap_code_tax_org.setModel((new ListModelList(com.is.utilsti.RefDataService.getTax(alias)))); 
     //   ap_code_bank.setModel((new ListModelList(com.is.utilsti.RefDataService.getMfo(alias)))); 
        //ap_code_class_credit.setModel((new ListModelList(com.is.utilsti.RefDataService.getClassCR()))); 
        ap_code_citizenship.setModel((new ListModelList(com.is.utilsti.RefDataService.getCountry(alias))));
        acode_country.setModel((new ListModelList(com.is.utilsti.RefDataService.getCountry(alias))));
       // ap_birth_place.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr()))); 
        //ap_code_capacity.setModel((new ListModelList(com.is.utilsti.RefDataService.getCapacity()))); 
        ap_code_gender.setModel((new ListModelList(com.is.utilsti.RefDataService.getGender(alias)))); 
        ap_code_nation.setModel((new ListModelList(com.is.utilsti.RefDataService.getNation(alias)))); 
        ap_code_birth_region.setModel((new ListModelList(com.is.utilsti.RefDataService.getRegion(alias)))); 
        ap_code_birth_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(alias)))); 
        //ap_type_document.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_document()))); 
        ap_code_adr_region.setModel((new ListModelList(com.is.utilsti.RefDataService.getRegion(alias)))); 
        ap_code_adr_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(alias)))); 
      //  acode_type.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_client(alias)))); 
        acode_resident.setModel((new ListModelList(com.is.utilsti.RefDataService.getRezCl(alias))));

        
        fp_code_tax_org.setModel((new ListModelList(com.is.utilsti.RefDataService.getTax(alias)))); 
        //fp_code_bank.setModel((new ListModelList(com.is.utilsti.RefDataService.getMfo(alias)))); 
        //fp_code_class_credit.setModel((new ListModelList(com.is.utilsti.RefDataService.getClassCR(alias)))); 
        fp_code_citizenship.setModel((new ListModelList(com.is.utilsti.RefDataService.getCountry(alias)))); 
        fp_code_gender.setModel((new ListModelList(com.is.utilsti.RefDataService.getGender(alias)))); 
        fp_code_nation.setModel((new ListModelList(com.is.utilsti.RefDataService.getNation(alias)))); 
        fp_code_birth_region.setModel((new ListModelList(com.is.utilsti.RefDataService.getRegion(alias)))); 
        fp_code_birth_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(alias)))); 
        fp_type_document.setModel((new ListModelList(com.is.utilsti.RefDataService.getType_document(alias)))); 
        fp_code_adr_region.setModel((new ListModelList(com.is.utilsti.RefDataService.getRegion(alias)))); 
        fp_code_adr_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(alias)))); 
...
try{
		...
		//if(CheckNull.checkForm(addgrdr)&&(CheckNull.checkForm(addgrdl)))		{
			...
			*/
			...
			//	new_customer.setAcode_tel(acode_tel.getValue());
				...
				new_customer.setP_pinfl(ap_pinfl.getValue());
	...
	//	Res res1 =
	//		CustomerService.doAction(session.getAttribute("un").toString(), session.getAttribute("pwd").toString(), tcustomer, 2, alias, true);
			if(res.getCode()!=0){
				alert(res.getName());
			}else{
        ...
        //CustomerService.doAction(session.getAttribute("un").toString(), session.getAttribute("pwd").toString(), current, 1,2, alias, true);
    }
    onClick$btn_back();
    refreshModel(_startPageNumber);
    SelectEvent evt = new SelectEvent("onSelect", dataGrid,dataGrid.getSelectedItems());
...
public void onClick$btn_tst() {
	//OperationConnectionInfo connectionInfo = new OperationConnectionInfo("01","01",null,null);
	...
	//RowType_CustomerCustomInfo[] cci ={ new RowType_CustomerCustomInfo("1","jopa")};
	RowType_CustomerCustomInfo[] cci ={ };
//	ListType_CustomerCustomInfoHolder customListInfo =new ListType_CustomerCustomInfoHolder(cci);
...
//	IssuingPortProxy pp = new IssuingPortProxy("http://iss_ws:visaipak@213.206.37.122:8083/issuingws/services/Issuing");
//	IssuingPortProxy pp = new IssuingPortProxy("http://iss_ws:visaipak@10.11.0.63:8083/issuingws/services/Issuing");
//	IssuingPortProxy pp = new IssuingPortProxy("http://127.0.0.1:8083/issuingws/services/Issuing");
	try {
...
public void onSelect$ap_code_birth_region(Event evt) {
	...
	ap_code_birth_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(ap_code_birth_region.getValue()))));
}
public void onSelect$ap_code_adr_region(Event evt) {
	ap_code_adr_distr.setSelectedIndex(-1);
	ap_code_adr_distr.setModel((new ListModelList(com.is.utilsti.RefDataService.getDistr(ap_code_adr_region.getValue()))));
}
...
/*public void onChange$ap_passport_number(Event evt){
	LtLogger.getLogger().info(ap_passport_number.getValue());
	 ...
	 List<Tclient> tetcl = TclientService.getTclient(ap_passport_number.getValue());
	 if(clist.size()>0){
		try{
