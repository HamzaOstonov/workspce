...
public class ClientAViewCtrl extends GenericForwardComposer {
	...
	protected Window sap_bapiret, sector_wnd, nibbd_modal, nibbd_wnd, account_wnd, fields_diff_wnd, searchWnd,
			clientmain, specclt_wnd, clt_dlg_wnd, director_search_wnd, appsWnd,fltr_Client;
	...
	protected Toolbarbutton btn_last, btn_next, btn_prev, btn_first, btn_save, btn_clear, btn_back, btn_get_ip,
			btn_sendFile, btn_new, btn_digId;
...
//	private static HttpServletRequest request;
	...
	public void onDoubleClick$dataGrid$grd() {
		...
		if(currentListItem.getP_Date_ApprovedNibbd() ==null){
	...
	public void onChange$regionValue() {
		...
		System.out.println("regionValue.getValue():  " + regionValue.getValue());
		System.out.println("current.getJ_region():   " + current.getJ_region());
	}
	...
	public void onAccept(Event event) throws Exception { // Слушаем ответа с js
															// если есть
															// получаем и
															// присваеваем
	...
	public void onClick$btn_digId() {
		...
		Clients.evalJavaScript("Scan_DigId();"); // вызываем метод из .js файла
