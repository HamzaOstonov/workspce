    ...
    */
    ...
    public ClientA(Long id, String branch, String id_client, String name, String code_country, String code_type,
                   ...
                   String p_post_address_house, String p_post_adress_flast, String sign_100,
                           ...
                           String  p_Code_Nibbd,Date p_Date_ApprovedNibbd,Date p_Date_ClosedNibbd) {
        super();
        this.id = id;
	...
	public String toString() {
		return "ClientA [id=" + id + ", branch=" + branch + ", id_client=" + id_client + ", id_client_in_sap="
				...
				+ ", p_pass_place_district=" + p_pass_place_district + ", p_post_address_quarter="
				+ p_post_address_quarter + ", p_post_address_street=" + p_post_address_street
				...
				+ j_sign_dep_acc + ", j_type_activity=" + j_type_activity + ", id_sap=" + id_sap + ", capital_inform="
