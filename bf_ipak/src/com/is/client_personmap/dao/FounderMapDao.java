...
public class FounderMapDao implements Dao<FounderMap> {
	...
	@Override
	public List<FounderMap> getList() {
		throw new UnsupportedOperationException();
	}
	@Override
	public List<FounderMap> getListWithPaging(int pageIndex, int pageSize) {
		throw new UnsupportedOperationException();
	}
	
	@Override
	public FounderMap getItemByLongId(String branch,long idPersonMap) {
		throw new UnsupportedOperationException();
	}
	
	@Override
	public FounderMap getItemByLongId(Connection c, String branch,long idPersonMap) {
	...
	@Override
	public FounderMap getItemByStringId(String branch,String itemId) {
		throw new UnsupportedOperationException();
	}
	/**
	 ...
	 * */
	@Override
	public FounderMap getItemByStringId(Connection c, String branch,String idPersonMap) {
		PreparedStatement ps = null;
		CallableStatement init = null;
		ResultSet rs = null;
		FounderMap founderMap = null; 
	...
	@Override
	public int remove(Connection c, FounderMap item) throws Exception {
		PreparedStatement ps = null;
		CallableStatement init = null;
		int count = 0; 
		try {
