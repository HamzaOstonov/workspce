...
public class FounderCapital {
    ...
    @Getter
    @Setter
    protected long idPersonMap;
    @Getter
    @Setter
    protected BigDecimal part_of_capital;
    @Getter
    @Setter
    protected BigDecimal part_of_capital_old;
    @Getter
    @Setter
    protected BigDecimal sum_a;
    @Getter
    @Setter
    protected BigDecimal sum_b;
    @Getter
    @Setter
    protected String currency;
    @Getter
    @Setter
    protected String is_director;
    @Getter
    @Setter
    protected BigDecimal shares_number;
    @Getter
    @Setter
    protected String founder_type;
...
//    @Getter @Setter protected BigDecimal sumBOld;
    ...
    public FounderCapital(String currency, BigDecimal part_of_capital, BigDecimal sum_a) {
