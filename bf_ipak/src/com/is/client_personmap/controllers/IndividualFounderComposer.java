...
public class IndividualFounderComposer extends AbstractFounderController<Person> {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        current = PersonMap.individFounderInstance(ses_branch);
    ...
    protected void executeFounderAction(final int action) {
        try {
            ...
            current.getPerson().setParent_id_client_j(current.getClient_id()); //2022.11.16
            current.getPerson().setPerson_role(current.getPerson_kind()); //2022.12.28
            current.getPerson().setEmp_id(ses_uId);
            // 05-03-2018
...
//	}
    ...
    public void creation(Person person) {
        ...
        is_beneficiary.setVisible(true);
