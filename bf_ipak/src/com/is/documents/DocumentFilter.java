...
public class DocumentFilter implements Serializable {
	...
	private Date d_date;
	private Date d_date_from;
	private Date d_date_to;
    ...
    public DocumentFilter(Long id, String branch, String doc_num, Date d_date,
			...
			String budget_account, String budget_inn) {
		super();
		this.id = id;
		this.branch = branch;
	...
	public Date getD_date_from() {
		return d_date_from;
	}

	public void setD_date_from(Date d_date_from) {
		this.d_date_from = d_date_from;
	}

	public Date getD_date_to() {
		return d_date_to;
	}

	public void setD_date_to(Date d_date_to) {
		this.d_date_to = d_date_to;
	}
