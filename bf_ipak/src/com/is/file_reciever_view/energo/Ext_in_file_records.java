...
public class Ext_in_file_records
{
    ...
    public Ext_in_file_records()
    {
    }

    public Ext_in_file_records( Long id, Long in_file_id, Long type_record_id, String rec_value, Long error_id, String err_message)
    {
