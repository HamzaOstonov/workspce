...
public class Cattle extends GenericForwardComposer{

	private static final long serialVersionUID = 1L;
	
	private Div cattlediv,grd;
	private Textbox id_client,name,massiv,street,home,home_num,doc_num,notarial_doc_numb,inn,name2;
	...
	private void inputDatas(){
		if(clickbtn.equals("double")){
			...
			Utils.clearForm(cattlediv);
			cattlediv.setVisible(false);
		}
