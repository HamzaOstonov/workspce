...
public class Nonpayacc extends GenericForwardComposer{

	private static final long serialVersionUID = 1L;
	
	private Div nonpayaccdiv,grd;
	...
	private void inputDatas(){
		if(clickbtn.equals("double")){
			...
			Utils.clearForm(nonpayaccdiv);
			nonpayaccdiv.setVisible(false);
		}
