package com.is.korona_pay.model;
...
import com.is.clientcrm.ClientA;
	...
	public class dper_info{
		...
		public dper_info(String branch, String mbranch, Long id, String veoper,
				String kind, String strs, String strr, String distr, BigDecimal summa,
				String currency, Date v_date, String client, String client_name1,
				String client_name2, String client_name3, String rezident,
				String doc_id, String doc_series, String doc_number,
				...
				BigDecimal summa2, BigDecimal summa3, BigDecimal summa4, BigDecimal summa5,
				String client_i13code_str, String region_offshor,
				String client_grstr) {
			super();
			this.branch = branch;
		...
		public void setClientData(ClientA client) {
			if(client != null) {
				client_name1 = client.getP_family();
				client_name2 = client.getP_first_name();
				client_name3 = client.getP_patronymic();
				birthday = client.getP_birthday();
				doc_date_issue = client.getP_passport_date_registration();
				doc_id = client.getP_type_document();
				doc_number = client.getP_passport_number();
				doc_series = client.getP_passport_serial();
				doc_issue = client.getP_passport_place_registration();
				post_address = client.getP_post_address();
				rezident = client.getCode_resident();
				this.client = client.getId_client();
			}
		}
