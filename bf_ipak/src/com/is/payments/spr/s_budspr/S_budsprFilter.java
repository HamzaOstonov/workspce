...
public class S_budsprFilter implements Serializable {
    ...
    public S_budsprFilter() {
		super();
    }

    public S_budsprFilter(String nci_id, String treasure_id, String account, String inn, String name, Date date_open, Date date_close, String act, String bank_id, String bankacc, String bankinn, String bankaccname) {
		super();
		this.nci_id = nci_id;
