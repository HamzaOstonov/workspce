...
public abstract class AbstractPagingListModel<T> extends AbstractListModel {
    ...
    public AbstractPagingListModel(int startPageNumber, int pageSize, Object fl) {
            super();
            ...
            _items = getPageData(_itemStartNumber, _pageSize,fl);
    }

    public abstract int getTotalSize();
    public abstract int getTotalSize(Object fl);
    protected abstract List<T> getPageData(int itemStartNumber, int pageSize);
    protected abstract List<T> getPageData(int itemStartNumber, int pageSize,Object fl);
