...
public class Customer_ReqestOutBindingStub extends org.apache.axis.client.Stub
		implements client.NCI.com.ipakyulibank.client_p.Customer_ReqestOut {
	...
	private static void _initOperationDesc1() {
		...
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName(
						"urn:ipakyulibank.com:CRM:client",
						"BusinessPartnerChangeReqest"),
				org.apache.axis.description.ParameterDesc.IN,
				new javax.xml.namespace.QName(
						"urn:ipakyulibank.com:NCI:client",
						"BusinessParnerComplex"),
				client.NCI.com.ipakyulibank.client_p.BusinessParnerComplex.class,
				false, false);
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BusinessPartnerResponce"));
		oper.setReturnClass(client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponce.class);
		oper.setReturnQName(new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client",
				"BusinessPartnerChangeResponce"));
		...
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName(
						"urn:ipakyulibank.com:NCI:client",
						"BusinessPartnerContentReqest"),
				org.apache.axis.description.ParameterDesc.IN,
				new javax.xml.namespace.QName(
						"urn:ipakyulibank.com:NCI:client",
						"BusinessPartnerContentReqest"),
				client.NCI.com.ipakyulibank.client_p.BusinessPartnerContentReqest.class,
				false, false);
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BusinessParnerComplex"));
		oper.setReturnClass(client.NCI.com.ipakyulibank.client_p.BusinessParnerComplex.class);
		oper.setReturnQName(new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client",
				"BusinessPartnerContentResponce"));
		oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
		oper.setUse(org.apache.axis.constants.Use.LITERAL);
		_operations[1] = oper;
		...
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName(
						"urn:ipakyulibank.com:CRM:client",
						"BusinessPartnerSearchReqest"),
				org.apache.axis.description.ParameterDesc.IN,
				new javax.xml.namespace.QName(
						"urn:ipakyulibank.com:NCI:client",
						"BusinessPartnerSearchReqest"),
				client.NCI.com.ipakyulibank.client_p.BusinessPartnerSearchReqestReqest[].class,
				false, false);
		param.setItemQName(new javax.xml.namespace.QName("", "reqest"));
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client",
				"BusinessPartnerSearchResponce"));
	...
	public Customer_ReqestOutBindingStub(java.net.URL endpointURL,
			javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public Customer_ReqestOutBindingStub(javax.xml.rpc.Service service)
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", ">BPAttachments>attachment");
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client",
				">BusinessPartnerResponceHeader>id_client_sap");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client",
				">BusinessPartnerSearchReqest>reqest");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BAPIRET2");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BPAttachments");
		cachedSerQNames.add(qName);
		cls = client.NCI.com.ipakyulibank.client_p.BPAttachmentsAttachment[].class;
		cachedSerClasses.add(cls);
		qName = new javax.xml.namespace.QName(
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BusinessPartnerContent");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BusinessPartnerNCI");
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName(
				"urn:ipakyulibank.com:NCI:client", "BusinessPartnerTab");
		cachedSerQNames.add(qName);
		cls = client.NCI.com.ipakyulibank.client_p.BusinessPartnerNCI[].class;
		cachedSerClasses.add(cls);
		qName = new javax.xml.namespace.QName(
	...
	public client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponce customer_Reqest(
		...
		try {
			java.lang.Object _resp = _call
					.invoke(new java.lang.Object[] { businessPartnerChangeReqest });
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponce) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponce.class);
				}
			}
	...
	public client.NCI.com.ipakyulibank.client_p.BusinessParnerComplex getDetails(
		...
		try {
			java.lang.Object _resp = _call
					.invoke(new java.lang.Object[] { businessPartnerContentReqest });
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (client.NCI.com.ipakyulibank.client_p.BusinessParnerComplex) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									client.NCI.com.ipakyulibank.client_p.BusinessParnerComplex.class);
				}
	...
	public client.NCI.com.ipakyulibank.client_p.BusinessPartnerSearchResponce search(
		...
		try {
			java.lang.Object _resp = _call
					.invoke(new java.lang.Object[] { businessPartnerSearchReqest });
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (client.NCI.com.ipakyulibank.client_p.BusinessPartnerSearchResponce) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									client.NCI.com.ipakyulibank.client_p.BusinessPartnerSearchResponce.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
