...
public class BusinessPartnerResponce  implements java.io.Serializable {
    private client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponceHeader header;

    private client.NCI.com.ipakyulibank.client_p.BAPIRET2[] messages;

    public BusinessPartnerResponce() {
    }

    public BusinessPartnerResponce(
           client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponceHeader header,
           client.NCI.com.ipakyulibank.client_p.BAPIRET2[] messages) {
           this.header = header;
     ...
     * @return header
     */
    public client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponceHeader getHeader() {
        return header;
    }
     ...
     * @param header
     */
    public void setHeader(client.NCI.com.ipakyulibank.client_p.BusinessPartnerResponceHeader header) {
        this.header = header;
    }
     ...
     * @return messages
     */
    public client.NCI.com.ipakyulibank.client_p.BAPIRET2[] getMessages() {
        return messages;
    }
     ...
     * @param messages
     */
    public void setMessages(client.NCI.com.ipakyulibank.client_p.BAPIRET2[] messages) {
        this.messages = messages;
    }

    public client.NCI.com.ipakyulibank.client_p.BAPIRET2 getMessages(int i) {
        return this.messages[i];
    }

    public void setMessages(int i, client.NCI.com.ipakyulibank.client_p.BAPIRET2 _value) {
