...
public abstract class AbstractPagingListModel<T> extends AbstractListModel {
    ...
    public AbstractPagingListModel(int startPageNumber, int pageSize, Object fl, String alias, boolean sorted_desc) {
        super();
        ...
        _items = getPageData(_itemStartNumber, _pageSize,fl, alias, sorted_desc);
}
    ...
    protected abstract List<T> getPageData(int itemStartNumber, int pageSize,Object fl, String alias, boolean sorted_desc);
