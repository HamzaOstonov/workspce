...
public void doAfterCompose(Component comp) throws Exception {
    ...
    fbranch.setModel((new ListModelList(com.is.utils.RefDataService.getMfo(alias))));
    foperation_id.setModel((new ListModelList(com.is.utils.RefDataService.getOperation(Integer.parseInt(group_id[0]), alias))));
