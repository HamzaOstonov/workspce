...
public class ComServicesList {
    ...
    public ComServicesList() {

    }

	public ComServicesList(int id, int customerj_id, int state, String name,
			...
			int client_address_mask, int pay_cat_id, int district_mask) {
		super();
		this.id = id;
		...
		this.district_mask = district_mask;
	}
	...
	public int getDistrict_mask() {
		return district_mask;
	}

	public void setDistrict_mask(int district_mask) {
		this.district_mask = district_mask;
	}
