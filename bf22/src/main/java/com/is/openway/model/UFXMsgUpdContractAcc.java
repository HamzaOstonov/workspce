...
public class UFXMsgUpdContractAcc {
	 ...
	 private MsgDataUpdContract MsgDataObject;
	 ...
	 @JsonProperty("MsgData")
	 public MsgDataUpdContract getMsgDataReq() {
	 ...
	 @JsonProperty("MsgData")
	 public void setMsgDataReq(MsgDataUpdContract MsgDataObject) {
