...
public class Customer
{
    ...
    public String toString() {
        ...
        this.p_family + ", p_first_name=" + this.p_first_name + ", p_patronymic=" + this.p_patronymic + 
          ", t_r_street=" + this.t_r_street + ", t_person_code=" +     this.t_person_code + ", way_exist=" + this.way_exist  +
          ", t_client=" + this.t_client + ", t_bank_c=" +     this.t_bank_c + ", t_client_b=" + this.t_client_b  +
	...
	public void copyTietoFields (Customer old, Customer newCust) {
		//Customer newCust=new Customer();

		newCust.setT_client(old.getT_client());
