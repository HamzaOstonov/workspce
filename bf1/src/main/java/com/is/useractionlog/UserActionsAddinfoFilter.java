...
public class UserActionsAddinfoFilter implements Serializable {
    ...
    public UserActionsAddinfoFilter() {
		super();
    }

    public UserActionsAddinfoFilter(Long id, String a_key, String a_value) {
		super();
		this.id = id;
		this.a_key = a_key;
